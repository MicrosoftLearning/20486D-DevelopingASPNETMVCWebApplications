...
2. In the async **lamda expression** of the **Use** method, add an **IF** statemet that checks if the  **context.Request.Query.ContainsKey** method returns **TRUE**. Pass **"favorite"** as a parameter to the **ContainsKey** method. 
...
4. Select **Basketball**, and then click **Submit Query**.
...
5. Select **Basketball**, and then click **Submit Query**.
...
5. Select **Basketball**, and then click **Submit Form**.
...
8. Select **Football**, and then click **Submit Form**.
...
11. Select **Basketball**, and then click **Submit Form**.
...
4. Select **Basketball**, and then click **Submit Form**.
...
7. Select **Football**, and then click **Submit Form**.
...
10. Select **Basketball**, and then click **Submit Form**.

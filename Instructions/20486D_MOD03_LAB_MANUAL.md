...
5. In the **Configure** method, call the **Run** method of the  **app** parameter. Pass a lambda expression to the **Run** method with the following information:

    - Parameter: **async (context)**
    - Statement Block :  **await context.Response.WriteAsync("This text was generated by the app.Run middleware.")**

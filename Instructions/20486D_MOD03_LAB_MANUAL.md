...
6. In the async **lamda expression**, call the **context.Response.WriteAsync** method using the **await** operator. Pass **"This text was generated by the app.Run middleware."** as a parameter to the **WriteAsync** method. 
...
1. In **Startup.cs** class, in the **Configure** method code block, call the **UseStaticFiles** method of the **app** parameter.
...
2. In the async **lamda expression** of the **Use** method, add an **IF** statemet that check that **context.Request.Query.ContainsKey** method returns **TRUE**. Pass **"favorite"** as a parameter to the **ContainsKey** method. 
...
1. In the **Startup** class, in the **Configure** method, move the **app.UseStaticFiles** method call to be the beginnig of the middleware pipline.
...
1. In **Startup** class, in the **Configure** method, invoke the **UseMvcWithDefaultRoute** method between the **UseStaticFiles** and the **app.Run** middleware.

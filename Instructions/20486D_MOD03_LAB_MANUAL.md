...
3. Access the following relative path:
    - Path: **/poll-questions.html**
    > **Note**: Verify that the browser displays the **poll-questions.html** file content, the HTML content is not designed by a css file yet.
...
9. Access the following relative path: 
    - Path: **/poll-questions.html**
    > **Note**: Verify that the browser displays the **poll-questions.html** content, the HTML content is designed by the **style.css**.

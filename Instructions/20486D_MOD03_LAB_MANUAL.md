...
4. In the **Startup** class, move the **app.UseStaticFiles** middleware to the first place in the pipeline.
...
8. Move the **app.Run** middleware to the last place in the pipeline.

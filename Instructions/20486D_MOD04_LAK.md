...
13. In the Microsoft Edge window, on the Earth image click the **London** area, note the red arrow in the center of the Earth image.
...
15. On the **DEBUG** menu of the **WorldJourney (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.

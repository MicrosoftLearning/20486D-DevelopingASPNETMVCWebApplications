...
1. Navigate to **Allfiles\Mod04\Labfiles\01_WorldJourney_begin**, and then double-click **WorldJourney.sln**.

2. In **Solution Explorer**, right-click **WorldJourney**, point to **Add**, and then click **New Folder**.

3. In the **NewFolder** text box, type **Controllers**, and then press Enter.

4. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.
...
7. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.

8. In the **Add Scaffold** dialog box, click **MVC Controller - Empty**, and then click **Add**.

9. In the **Add Empty MVC Controller** dialog box, in the **Controller name** text box, type **CityController**, and then click **Add**.
...
2. In the **WorldJourney - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**.
...
5. In the **WorldJourney (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
1. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.

2. In the **Add Scaffold** dialog box, click **MVC controller - Empty**, and then click **Add**.

3. In the **Add Empty MVC Controller** dialog box, in the **Controller name** text box, type **TravelerController**, and then click **Add**.
...
3. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]/Traveler/Index**, and then press Enter.
      ...
      >**Note:** In the next task you will register a new route with the routing table. Then you will not need to manually write the **Traveler/Index** relative URL in the address bar.

3. In **Microsoft Edge**, click **Close**.

4. In the **WorldJourney (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
8. Click **Go Next**. 
    ...
    >**Note:** Verify that the new route works. As a result of applying custom route to **CityController** in the **Index** action by using attributes, **http://localhost:[port]/WorldJourney** should appear in the address bar.
...
12. Put the cursor over the **Earth** image, and then left click.
...
13. In **Microsoft Edge**, on the **Earth** image, click the **London** area. Note the red arrow at the center of the **Earth** image.
    ...
    >**Note:** Verify that the new route works. As a result of applying custom route to a **CityController** in the **Details** action using attributes, **http://localhost:[port]/CityDetails/2** should appear in the address bar.

14. In **Microsoft Edge**, click **Close**.

15. In the **WorldJourney (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
1. In **Solution Explorer**, right-click **WorldJourney**, point to **Add**, and then click **New Folder**.

2. In the **NewFolder** text box, type **Filters**, and then press Enter.

3. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Filters**, point to **Add**, and then click **Class**.

4. In the **Add New Item – WorldJourney** dialog box, in the **Name** text box, type **LogActionFilterAttribute**, and then click **Add**.
...
7. In the **WorldJourney (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.

8. In the **WorldJourney - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

9. Navigate to **Allfiles\Mod04\Labfiles\01_WorldJourney_begin\WorldJourney\LogFile**, click **Text file**. 

    >**Note:** **Text file** displays the new filter result.

>**Results**: After completing this exercise, you should have created an action filter class that logs the details of actions, controllers, and parameters to an external file whenever an action is called.

...
8. In the **GetImage** action code block, select the following code, and then press Delete.

  ```cs
       string fullPath = "";
```

9.  In the **GetImage** action code block, locate the following code.
...
3. In the Microsoft Edge window, on the Earth image click the **London** area, note the red arrow in the centre of the Earth image.
...
6. Put the cursor over the **Go Next** button.

    >**Note:** Verify in the **Developer Tools**, the **a** tag **href** attribute value.

7. Click the **Go Next** button. 

    >**Note:** Verify that the new routes work. The Address bar of the Microsoft Edge window is **http://localhost:[port]/WorldJourney**, as a result of applying custom route to a **CityController** in the **Index** action using attributes.

8. In the Microsoft Edge window, on the Earth image click the **London** area, note the red arrow in the centre of the Earth image.

    >**Note:** Verify that the new routes work. The Address bar of the Microsoft Edge window is **http://localhost:[port]/CityDetails/2**, as a result of applying custom route to a **CityController** in the **Details** action using attributes.

9. In the Microsoft Edge window, click **Close**.

10. On the **DEBUG** menu of the **WorldJourney (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.
...
4. In the Microsoft Edge window, on the Earth image click the **London** area, note the red arrow in the centre of the Earth image.

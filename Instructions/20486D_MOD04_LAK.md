...
3. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.
...
6. In the **WorldJourney - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.

7. In the **Add Scaffold** dialog box, click **MVC Controller - Empty**, and then click **Add**.

8. In the **Add Empty MVC Controller** dialog box, in the **Controller name** text box, type **CityController**, and then click **Add**.
...
>**Results**: After completing this exercise, you will be able to add custom routes by using attributes for **CityController** in the application.
...
4. In the **Add New Item – WorldJourney** dialog box, in the **Name** text box, type **LogActionFilter**, and then click **Add**.

5. In **LogActionFilter** locate the following code:
  ```cs

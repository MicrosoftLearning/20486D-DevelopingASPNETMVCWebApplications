...
6. In the third **Microsoft Edge**, in the address bar, type **http://localhost:[port]/products/index/1/RefreshCache**, and then press Enter.
...
13. On the **Add Products to Shopping List** page, in the **Products List** list, select again _&lt;Products of your choice&gt;,_ and then click **Add to Shopping List**.
...
18. Close all **Microsoft Edge** windows.

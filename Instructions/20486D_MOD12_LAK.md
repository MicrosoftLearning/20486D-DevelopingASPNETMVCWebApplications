...
2. In the **File Explorer**, navigate to **Allfiles\Mod12\Labfiles\01_ElectricStore_begin\ElectricStore**, and then copy the address in the address bar.
...
9. In the **File Explorer**, navigate to **Allfiles\Mod12\Labfiles\01_ElectricStore_begin**, and then double-click **ElectricStore.sln**.

10. In the **ElectricStore - Microsoft Visual Studio** window, on the **TOOLS** menu, click **Options**.

11. In the **Options** dialog box, in the **Search Options** text box, type **Web Package Management**, and then press Enter.

12. In the **Locations of external tools** list box, select **$(PATH)**, press the **Ap arrow** button until **$(PATH)** is at the top of the list, and then click **OK**.
...
4. In the second **Microsoft Edge**, in the address bar, type **http://localhost:[port]**, and then press Enter.

    >**Note:** Examine the browser content, the menu bar of the application is cached since the time displayed in the menu bar is the same in the two **Microsoft Edge** pages.
    
5. In the third **Microsoft Edge**, in the address bar, type **http://localhost:[port]/products/index/1/RefreshCache**, and then press Enter.

    >**Note:** The menu bar of the application is cached since the time displayed in the menu bar is not the same as the other two **Microsoft Edge** pages because the **RefreshCache** in the route triggers a reload of the view component.
...
12. In the menu bar, click **Add to Shopping List**.

    >**Note:** Examine the browser content, the browser displays your personal information cached.

13. On the **Add Products to Shopping List** page, in the **Products List** list, select again _&lt;Products of your choice&gt;._

14. In the menu bar, click **My Shopping Card**.
...
16. In the second **Microsoft Edge**, in the address bar, type **http://localhost:[port]**, and then press Enter.

17. In the menu bar, click **My Shopping Card**.

...
```
16. Place the cursor after the **>** (greater than) sign of the **&lt;ul&gt;** tag, press Enter, and then type the following code: 
  ```cs
...
7. In the **NavbarMenuViewComponent.cs** code window, select the following code:
```cs
...
14. In the **ElectricStore - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **NavbarMenu** folder you just created, point to **Add**, and then click **New Item**.
...
1. In the **ElectricStore - Microsoft Visual Studio** window, in **Solution Explorer**, right-click the **Controllers** folder, point to **Add**, and then click **Controller**.
...
5. On the **Add to Shopping List** page, in the **Products List** list, select _&lt;Products of your choice&gt;._

6. On the **Add to Shopping List** page, in the **First Name** text box, type _&lt;A first name of your choice&gt;._

7. On the **Add to Shopping List** page, in the **Last Name** text box, type _&lt;A last name of your choice&gt;._

8. On the **Add to Shopping List** page, in the **Address** text box, type _&lt;An address of your choice&gt;._

9. On the **Add to Shopping List** page, in the **Email** text box, type _&lt;An email of your choice&gt;._

10. On the **Add to Shopping List** page, in the **Phone** text box, type _&lt;A phone number of your choice&gt;,_ and then click **Add to Shopping List**.
...
1. In the **ElectricStore - Microsoft Visual Studio** window, in **Solution Explorer**, expand **Controllers**, and then click **ShoppingCardController.cs**.
       ...
       <div class="chat">
           <div class="row justify-content-center">
               <div class="col-2 bcf">
                   ...
                   <div class="col-sm-3">
                       <input class="btn btn-info" type="button" id="sendMessageBtn" value="Send Message" />
                   </div>
               </div>
               <div class="col-2 bcs">
...
5. In the **ElectricStore - Microsoft Visual Studio** window, in **Solution Explorer**, expand **Views**, expand **ShoppingCard**, and then click **Chat.cshtml**.
...
7. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]**, and then press Enter.

8. In **Microsoft Edge**, click on one of the squares.


    >**Note**: In both the **Microsoft Edge** windows, the square that was clicked is red.

9. On the taskbar, right-click the **Microsoft Edge** icon, and then click **New Window**.
...
12.  In the **SignalRExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

13. In **Microsoft Edge**, click **Close**.

14. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

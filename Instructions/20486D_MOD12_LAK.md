...
12. In the **Index.cshtml** code window, located the following code:
  ```cs
       ...
       {
           <h2 class="title">
               <span class="span-col-s">Sorry we don't have any information yet</span>
               <span>Please go to</span>
               <span class="span-col-s">Shopping List page</span>
               <span>and select wanted products</span>
           </h2>
       }
```
...
5. In the **ElectricStore - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, expand **ShoppingCard**, and then click **Chat.cshtml**.
...
8. In **Microsoft Edge**, in the **Name** text box, type _&lt;A name of your choice&gt;._
...
13.  In the **SignalRExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

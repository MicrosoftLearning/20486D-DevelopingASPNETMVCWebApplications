...
2. In File Explorer, navigate to **Allfiles\Mod12\Labfiles\01_ElectricStore_begin\ElectricStore**, and then copy the address in the address bar.
...
9. In File Explorer, navigate to **Allfiles\Mod12\Labfiles\01_ElectricStore_begin**, and then double-click **ElectricStore.sln**.
...
5. In the **Add New Item - ElectricStore** dialog box, in the **Name** box, type **chat-hub**, and then click **Add**.
...
9. In Microsoft Edge, in the **Message** box, type _&lt;A message of your choice&gt;._
...
11. In the first **Microsoft Edge** window, in the **Message** box, type _&lt;A message of your choice&gt;._

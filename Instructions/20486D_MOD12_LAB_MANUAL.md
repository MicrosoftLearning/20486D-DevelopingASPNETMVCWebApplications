...
3. In the **Administrator: Command Prompt** window, run the following command: **cd** *&lt;The location of Allfiles***\Mod12\Labfiles\01_ElectricStore_begin\ElectricStore folder on your machine&gt;*.

...
18. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll_questions.html, and then press Enter. 
     > **Note**: An empty page is displayed in the browser. Causing the next.Invoke method invocation to be commented, prevents the invocation of the UseStaticFiles method.

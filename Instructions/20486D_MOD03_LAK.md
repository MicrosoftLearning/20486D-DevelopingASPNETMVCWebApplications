...
2. In the **PollBall - Microsoft Visual Studio** window, verify that the **Solution Explorer** pane is opened. If not, go to **View**, and then click **Solution Explorer**.

3. In the **Solution Explorer** click the **Startup.cs**.
...
5. On the **Solution Explorer** pane, click **PollQuestions.html**.
...
4. Place the mouse cursor within the custom middleware code block you just created, and type the following code.
```cs
...
3. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click the **Submit Query** button.
...
1. In the Solution Explorer of the **PollBall –  Microsoft Visual Studio** window, click the **Startup.cs**.
...
5. Place the mouse cursor at the end of the located code, press Enter, right-click at the cursor location, and click **Paste**.
...
8. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click the **Submit Query** button.
...
14. Place the mouse cursor at the end of the located code, press Enter twice, right-click at the cursor location, and click **Paste**. 
...
1. In the **Solution Explorer** click the **Startup.cs**.
...
5. In the **Microsoft Edge**, PollQuestions page, click the **Football** radio button, and then click the **Submit Query** button.
...
7. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click the **Submit Query** button.
     > **Note**: The browser moved to a result page, and the following result is shown: 
...
4. In the **Solution Explorer** click the **Startup.cs**. 
...
8. Place the mouse cursor at the end of the code, and press Enter twice. 
...
16. Place the mouse cursor at the end of the code, and press Enter twice.
...
1. On the Solution Explorer click the **HomeController.cs**. 
...
8. In the **Microsoft Edge**, Change the URL path to http://localhost:[port] and press Enter. 
     > **Note**: The controller now returns the result: 
     >                  Game name: Basketball, Votes: 2
     >                  Game name: Football, Votes: 1 

...
2. Verify that the **Solution Explorer** pane is opened. If not, go to **View**, and then click **Solution Explorer**

3. In the **Solution Explorer** click the **Startup.cs** file.
...
1. In the **File Explorer** window, Go to **Allfiles\Mod03\Labfiles\01_PollBall_begin**, right-click the **Test.html** file, and then press **Copy**. 
...
1. In the Solution Explorer click the **Startup.cs** file.
...
4. In the **Solution Explorer** click the **Startup.cs** file. 

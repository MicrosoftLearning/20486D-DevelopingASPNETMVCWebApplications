...
9. In the **Solution Explorer** click the **Startup.cs**.
...
> **Note**: See that the **Hello World !** from the located code is the **Hello Word !** that is shown in the browser.
...
1. On the **DEBUG** menu of the **PollBall –  Microsoft Visual Studio** window, click **Start Debugging**.
     > **Note**: **Hello from controller** is shown in the browser.
...
8. In the **Microsoft Edge**, Change the URL path to http://localhost:[port], and then press Enter. 
     > **Note**: The **controller** returns the result: 
     >                  Game name: Basketball, Votes: 2
     >                  Game name: Football, Votes: 1 

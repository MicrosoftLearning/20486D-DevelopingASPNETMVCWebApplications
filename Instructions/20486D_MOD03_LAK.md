...
11. In the **Startup.cs** code window, place the mouse cursor within the **Startup** class code block,  bellow the **ConfigureServices** method, and then type the following code. 
```cs
...
13. In the **Name** box of the **Add New Item – PollBall** dialog box, type **poll-questions.html**, and then click **Add**.
...
2. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll-questions.html and then press Enter. 
     > **Note**: The **app.Run** generates the **Hello World !** text that is displayed in the browser, while the **poll-questions.html** file content is not displayed.
...
2. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll-questions.html, and then press Enter. 
     > **Note**: The **poll-questions.html** content is displayed in the browser, but the HTML content is not designed yet.

3. In the **Microsoft Edge** window, click **Close**.

4. On the **DEBUG** menu of the **PollBall  (Running) –  Microsoft Visual Studio** window, click **Stop Debugging**.

5. On the **Solution Explorer** pane, click **poll-questions.html**.

6. In the **poll-questions.html** code window, locate the following code, and then press Enter.
```cs
    <title></title>
```
...
9. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll-questions.html and then press Enter. 
     > **Note**: The **poll-questions.html** content is displayed in the browser, and designed by the **style.css** file.
...
2. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/test.html, and then press Enter. 
     > **Note**: The **app.Run** generates the **Hello World !** text that is displayed in the browser. By default, the user cannot reach static files that are outside the **wwwroot** directory from the browser.
...
5. Place the mouse cursor at the end of the located code, press Enter, right-click at the mouse cursor location, and then click **Paste**.

6. On the **DEBUG** menu of the **PollBall –  Microsoft Visual Studio** window, click **Start Debugging**.

7. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll-questions.html and then press Enter. 

8. In the **Microsoft Edge**, click the **Basketball** radio button, and then click the **Submit Query** button.
     > **Note**: The **poll-questions.html** file content is displayed in the browser.
...
14. Place the mouse cursor at the end of the located code, press Enter twice, right-click at the mouse cursor location, and then click **Paste**. 
...
17. On the **DEBUG** menu of the **PollBall  (Running) –  Microsoft Visual Studio** window, click **Start Debugging**.

18. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/poll-questions.html, and then press Enter. 
     > **Note**: An empty page is displayed in the browser (You might need to refresh the page in order to see the results). Commenting out the next.Invoke() method call will prevent the invocation of the UseStaticFiles method. 

19. In the **Microsoft Edge** window, click **Close**.

20. On the **DEBUG** menu of the **PollBall  (Running) –  Microsoft Visual Studio** window, click **Stop Debugging**.
...
8.	In the Solution Explorer pane of the **PollBall  (Running) - Microsoft Visual Studio** window, right-click the **Services**, point to **Add**, and then click **New Item**.
...
4. Start another **Microsoft Edge** window, Change the URL path to http://localhost:[port]/poll-questions.html and then press Enter.
...
6. Start another **Microsoft Edge** window, Change the URL path to http://localhost:[port]/poll-questions.html and then press Enter.
     > **Note**: Verify that the port number in the URL of the new **Microsoft Edge** window, is identical to the port number in the URL of the window that is created in step 2.
...
9. On the **DEBUG** menu of the **PollBall  (Running) –  Microsoft Visual Studio** window, click **Stop Debugging**.
...
3. On the **DEBUG** menu of the **PollBall  (Running) –  Microsoft Visual Studio** window, click **Stop Debugging**.
...
8. Place the mouse cursor at the end of the located code, and then press Enter twice. 

9. Right-click the mouse cursor location, and then click **Paste**.
...
16. Place the mouse cursor at the end of the located code, and then press Enter twice.

17. Right-click the mouse cursor location, and then click **Paste**.
...
3. Place the mouse cursor at the end of the located code, press Enter, and type the following code.
```cs
    using PollBall.Services;
    using System.Text;
``` 
...
5. Place the mouse cursor at the end of the located code, press Enter, type the following code.
```cs

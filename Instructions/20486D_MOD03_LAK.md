...
3. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click **Submit Query** button.
...
8. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click **Submit Query** button.
...
5. In the **Microsoft Edge**, PollQuestions page, click the **Football** radio button, and then click **Submit Query** button.
...
7. In the **Microsoft Edge**, PollQuestions page, click the **Basketball** radio button, and then click **Submit Query** button.
     > **Note**: The browser moved to a result page, and the following result is shown: 
...
15. Place the mouse cursor at the end of the code, press Enter twice, press right-click on the location, and click **Paste**.

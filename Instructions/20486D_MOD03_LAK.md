...
6.	In the **Name** box, type **PollBall**, and then click **OK**.
...
14. In the **PollQuestions.html** code window, in the **BODY** element,  type the following code, and then press Enter.
```cs
    <p class="head">
...
2. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/PollQuestions.html and then press Enter. 
...
6. In the **PollQuestions.html** code window, locate the following code, and then press Enter.
```cs
    <title></title>
```
...
9. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/PollQuestions.html and then press Enter. 
...
7. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/PollQuestions.html and then press Enter. 
...
18. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/PollQuestions.html, and then press Enter. 
...
4. Start another **Microsoft Edge** window, Change the URL path to http://localhost:[port]/PollQuestions.html and then press Enter.
...
6. Start another **Microsoft Edge** window, Change the URL path to http://localhost:[port]/PollQuestions.html and then press Enter.
     > **Note**: See that in the URL, the port number of the new window should be identical to the previous window's port.

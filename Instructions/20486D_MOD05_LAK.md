...
24. In the **BODY** element of the **ShowCities.cshtml** code window, type the following code:
```cs
    <h1>Select City</h1>
...
5. In the **CitiesDetails - Microsoft Visual Studio** window, in **Solution Explorer**, under **Controllers**, click **CityController.cs**.
...
10. In the **CityController.cs** code window, right-click the following code, and then click **Add View**.
```cs
    public IActionResult ShowDataForCity(string cityName)
```

11. In the **Add MVC View** dialog box, ensure that the name in the **View name** text box is **ShowDataForCity**.

12. In the **Add MVC View** dialog box, ensure that the check boxes are cleared, and then click **Add**.

13. In the **ShowDataForCity.cshtml** code window, locate the following code:
```cs
...
15. In the **ShowDataForCity.cshtml** code window, in the **BODY** element, type the following code:
```cs
    <div>
...
16. In the **CitiesDetails - Microsoft Visual Studio** window, in **Solution Explorer**, under **Controllers**, click **CityController.cs**.

17. In the **CityController.cs** code window, select the following code:
```cs

...
20. In the **BODY** element of the **ShowCities.cshtml** code window, type the following code:
```cs
    <h1>Select City</h1>
...
1. In the **CitiesDetails - Microsoft Visual Studio** window, in the **FILE** menu, click **Save All**.

2. In the **CitiesDetails - Microsoft Visual Studio** window, in the **DEBUG** menu, click **Start Debugging**.
...
4. In the **CitiesDetails (Running) - Microsoft Visual Studio** window, in the **DEBUG** menu, click **Stop Debugging**.
...
6. In the **CitiesDetails (Running) - Microsoft Visual Studio** window, in the **DEBUG** menu, click **Stop Debugging**.
...
3. In **Microsoft Edge**, click **Madrid**.
    >**Note**: The browser displays the City Name, Country, Time zone, Mini-Map, The region population and a Back link.

4. In **Microsoft Edge**, click **Close**.

5. In the **CitiesDetails (Running) - Microsoft Visual Studio** window, in the **DEBUG** menu, click **Stop Debugging**.

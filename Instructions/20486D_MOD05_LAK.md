...
1. Go to **Allfiles\Mod05\Labfiles\01_CitiesWebsite_begin**, and then double-click **CitiesWebsite.sln**.
...
21. In the **Add MVC View** dialog box, ensure that the name in the **View name** text box is **ShowCities**.

22. In the **Add MVC View** dialog box, ensure that **Empty (without model)** template is selected.

23. In the **Add MVC View** dialog box, ensure that the **Create as a partial view** and **Use a layout page** check boxes are unchecked, and then click **Add**.
...
2. In the **CitiesWebsite - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**.
...
4. In the **CitiesWebsite (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
1. In the **CitiesWebsite - Microsoft Visual Studio** window, in **Solution Explorer**, expand **Views**, expand **City**, and then click **ShowDataForCity.cshtml**.
...
4. In the **CitiesWebsite - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Views**, point to **Add**, and then click **New Item**.

5. In **Add New Item – CitiesWebsite** dialog box, in the navigation pane, under **Installed**, expand **ASP.NET Core**, and then click **Web**.

6. In **Add New Item – CitiesWebsite** dialog box, in the result pane, click **Razor View Imports**, and then click **Add**.
...
6. In the **CitiesWebsite (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
5. In the **Add MVC View** dialog box, ensure that **Empty (without model)** template is selected.

6. In the **Add MVC View** dialog box, ensure that the **Create as a partial view** check box is checked and the **Use a layout page** check box is unchecked, and then click **Add**.
...
5. In the **CitiesWebsite (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.

##	Exercise 3: Adding a View Component

###	Task 1: Add a view component class

1. In the **CitiesWebsite - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **CitiesDetails**, point to **Add**, and then click **New Folder**.
...
4. In the **Add New Item – CitiesWebsite** dialog box, in the **Name** text box, type **CityViewComponent**, and then click **Add**.
...
5. In the **CitiesWebsite - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **City**, point to **Add**, and then click **View**.
    
6. In the **Add MVC View** dialog box, in the **View name** text box, type **SelectCity**.

7. In the **Add MVC View** dialog box, ensure that **Empty (without model)** template is selected.

8. In the **Add MVC View** dialog box, ensure that the **Create as a partial view** check box is checked and the **Use a layout page** check box is unchecked, and then click **Add**.
...
6. In the **CitiesWebsite – Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

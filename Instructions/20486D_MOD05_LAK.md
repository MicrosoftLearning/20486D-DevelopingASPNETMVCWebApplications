...
1. In the Solution Explorer pane of the **CitiesDetails - Microsoft Visual Studio** window, expand **Services**, click **CityProvider.cs**.
...
10. In the Solution Explorer pane of the **CitiesDetails - Microsoft Visual Studio** window, expand **Controllers**, click **CityController.cs**.
...
1. On the **FILE** menu of the **CitiesDetails - Microsoft Visual Studio** window, click **Save All**.

2. On the **DEBUG** menu of the **CitiesDetails - Microsoft Visual Studio** window, click **Start Debugging**.
...
5. Place the cursor before the located code, type the following code, and then press Enter.
```cs
...
15. In the **Add MVC View** dialog box, ensure that the check boxes are cleared, and then click **Add**.
   >**Note**: In the **Add MVC View** dialog box, the **Reference script libraries** check box can be unchecked by setting the Template to Edit. Ensure setting back the Template to **Empty (without model)**.
...
1. In the Solution Explorer pane of the **CitiesDetails - Microsoft Visual Studio** window, expand **Views**, expand **City**, click **ShowDataForCity.cshtml**.
...
5. In the navigation pane of the **Add New Item – CitiesDetails** dialog box, under **Installed**, expand **ASP.NET Core**, and then click **Web**.
...
2. On the **DEBUG** menu of the **CitiesDetails - Microsoft Visual Studio** window, click **Start Debugging**.
    > **Note**: The browser displays a "Select City" title and list of city below it: Madrid, London and Paris.

3.  In the **Microsoft Edge** window, click the **London** link.
    > **Note**: The browser displays the City Name, Country, Time zone, Mini-Map and Back button.

4. In the **Microsoft Edge** window, click the **Back** link.

5. In the **Microsoft Edge** window, click **Close**.

6. On the **DEBUG** menu of the **CitiesDetails (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.
...
6. In the **Add MVC View** dialog box, ensure that the name in the **View name** box is **SelectCity**.

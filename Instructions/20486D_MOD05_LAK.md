...
21. In the Solution Explorer pane of the **CitiesDetails - Microsoft Visual Studio** window, in the **Controllers** folder, click **CityController.cs**.
...
2. In the Solution Explorer pane, name the newly created  folder as **Components**, and then press Enter.

3. In the Solution Explorer pane of the **CitiesDetails - Microsoft Visual Studio** window, right-click the **Components** folder you just created, point to **Add**, and then click **New Folder**.

4. In the Solution Explorer pane, name the newly created  folder as **City**, and then press Enter.

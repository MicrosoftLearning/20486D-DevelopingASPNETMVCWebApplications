...
1. Navigate to **Allfiles\Mod05\Labfiles\01_CitiesWebsite_begin**, and then double-click **CitiesWebsite.sln**.
...
2. In **Add New Item – CitiesWebsite** dialog box, in the navigation pane, under **Installed**, expand **ASP.NET Core**, and then click **Web**.

3. In **Add New Item – CitiesWebsite** dialog box, in the result pane, click **Razor View Imports**, and then click **Add**.

...
22. In the **Add MVC View** dialog box, ensure that the check boxes are unchecked, and then click **Add**.

23. In the **ShowCities.cshtml** code window, locate the following code:
```cs
...
25. In **ShowCities.cshtml** code window, in the **BODY** element, type the following code:
```cs
    <h1>Select City</h1>
...
8. In the **Add MVC View** dialog box, ensure that the check boxes are unchecked, and then click **Add**.

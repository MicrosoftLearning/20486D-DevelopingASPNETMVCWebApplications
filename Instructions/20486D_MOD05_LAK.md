...
5. Place the cursor before the located code, press Enter, type the following code, and press enter again.
```cs
...
5. In the result pane of the **Add New Item – CitiesDetails** dialog box, click **Razor View Import**, and then click **Add**.
...
3. In the **Solution Explorer** pane, right-click **Views**, point to **Add**, and then click **View**.
...
7. In the **_CityPopulation.cshtml** code window, locate the following code:
```cs
    <!DOCTYPE html>
```

...
1. Navigate to **Allfiles\Mod06\Labfiles\01_ButterfliesShop_begin**, and then double-click **ButterfliesShop.sln**.
...
7. In the **Add New Item – ButterfliesShop** dialog box, in the **Name** text box, type **IndexViewModel**, and then click **Add**.
...
8. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice from [Repositor]\AllFiles\Mod06\Labfiles\Images&gt;_, and then click **Submit**.
...
2. In the **ButterfliesShop - Microsoft Visual Studio** window, on the **DEBUG** menu, click **SStart Without Debugging**.

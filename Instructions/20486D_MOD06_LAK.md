...
6. In the **Add New Item – ButterfliesShop** dialog box, in the **Name** text box, type **IndexViewModel**, and then click **Add**.
...
```
6. Place the cursor at the end of the **DIV** element you just created, press Enter, and then type the following code:
  ```cs
...
3. In the **Microsoft Edge**, click **Close**.
...
4. In the **Butterfly.cs** code window, place the cursor at the end of the **Id** property code, press Enter, and then type the following code:
  ```cs
      [Display(Name = "Common Name:")]
```

5. In the **Butterfly.cs** code window, place the cursor at the end of the **CommonName** property code, press Enter, and then type the following code:
  ```cs
      [Display(Name = "Butterfly Family:")]
```

6. In the **Butterfly.cs** code window, place the cursor at the end of the **ButterflyFamily** property code, press Enter, and then type the following code:
  ```cs
      [Display(Name = "Butterflies Quantity:")]
```

7. In the **Butterfly.cs** code window, place the cursor at the end of the **Quantity** property code, press Enter, and then type the following code:
  ```cs
      [Display(Name = "Characteristics:")]
```

8. In the **Butterfly.cs** code window, place the cursor at the end of the **Characteristics** property code, press Enter, and then type the following code:
  ```cs
...
9. In the **Butterfly.cs** code window, place the cursor at the end of the **CreatedDate** property code, press Enter, and then type the following code:
  ```cs
...
9. In the **Microsoft Edge**, click **Close**.
...
2. In the **Butterfly.cs** code window, place the cursor at the end of the **Id** property code, press Enter twice, and then type the following code:
  ```cs
      [Required(ErrorMessage = "Please enter the butterfly name")]
```
3. In the **Butterfly.cs** code window, place the cursor at the end of the **CommonName** property code, press Enter twice, and then type the following code:
  ```cs
      [Required(ErrorMessage = "Please select the butterfly family")]
```

4. In the **Butterfly.cs** code window, place the cursor at the end of the **ButterflyFamily** property code, press Enter twice, and then type the following code:
  ```cs
      [Required(ErrorMessage = "Please select the butterfly quantity")]
```

5. In the **Butterfly.cs** code window, place the cursor at the end of the **Quantity** property code, press Enter twice, and then type the following code:
  ```cs
...
7. In the **Butterfly.cs** code window, place the cursor at the end of the **CreatedDate** property code, press Enter twice, and then type the following code:
  ```cs
...
2. In the **Create** action code block created with **HTTP POST** verb, locate the following code:
  ```cs
       ...
       {
```
3. Place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
  ```cs
...
4. On the **Add Butterflies to The Shop** page, leave all the fields blank, and then click the **Submit** button.
      ...
      >**Note:** The browser window displays the **Create.cshtml** view with validation messages beside all the fields.
...
9. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice&gt;,_ and then click the **Submit** button.

      >**Note:** Verify the newly submitted butterfly details.

10. In the **Microsoft Edge**, click **Close**.
...
10. Place the cursor at the end of the **MaxButterflyQuantityValidation** method code block, press Enter twice, type the following code, and then press Enter.
  ```cs
...
15. In the **Butterfly.cs** code window, locate the following code:
  ```cs
      [Required(ErrorMessage = "Please select the butterfly quantity")]
```
16.  Place the cursor before the located code, press Enter, press the Up Arrow key, and then type the following code:
  ```cs
...
8. On the **Add Butterflies to The Shop** page, in the **Butterflies Picture** box, select _&lt;A butterfly picture of your choice&gt;,_ and then click the **Submit** button.
      ...
      >**Note:** The browser window displays the **Create.cshtml** view with custom validation message beside the **Butterflies Quantity** field.

9. On the **Add Butterflies to The Shop** correct the **Butterflies Quantity** field with the custom validation message, type 2.
...
11. In the **Microsoft Edge**, click **Close**.

...
5. In the **BODY** element of the Index.cshtml code window, type the following code.
  ...
  ```cs
       <div>
           ...
           <button type="button" onclick="location.href='@Url.Action("Create", "Butterfly")'">Add Butteflies</button>
       </div>       
```
6. Place the mouse cursor at the end of the **DIV** element you just created, press **Enter** , and then type the following code.
  ...
  ```cs
       <div class="img-container">
          @foreach (var item in Model.Butterfiles)
          {
          }
       </div>      
```
...
1. In the Solution Explorer pane of the **ButterfliesShop - Microsoft Visual Studio** window, right-click **Models** folder, point to Add, and then click **class**.

2. In the **Name** box of the **Add New Item – ButterfliesShop** dialog box, type **IndexViewModel**, and then click Add.

3. In the **IndexViewModel** class code block, press Enter and then type the following code.

  ```cs
       public List<Butterfly> Butterfiles { get; set; }
```

4. In the Solution Explorer pane of the **ButterfliesShop - Microsoft Visual Studio** window, expand **Controllers**, and then click  **ButterflyController.cs**, locate the following code.
...
5. Ensure that the mouse cursor is at the end of the **Microsoft.AspNetCore.Mvc** namespace, press Enter, and then type the following code.
  ...
  ```cs
       using System.IO;
```
6. Place the mouse cursor at the end of the **InitializeButterfliesData** method code block, press Enter twice, and then type the following code.
...
7. In the **Index** action code block, type the following code.
...
8. Locate the **GetImage** action code block, and then locate the following code.
...
9. In the **IF** statement code block, select the following code.
...
3. In the **Create** action code block created with HTTP verb POST, type the following code, and then press Enter.
...
```
7. In the **Create** action code block created with HTTP verb POST, immediately after the code you just added, press Enter, and type the following code.
...
3. In the Microsoft Edge window,  click the **Add Butteflies** button.
...
2. In the **Butterfly** code window, place the mouse cursor at the end of the **Id** property code, press Enter, and then type the following code.

  ```cs
      [Required(ErrorMessage = "Please enter the butterfly name")]
```
3. In the **Butterfly** code window, place the mouse cursor at the end of the **CommonName** property code, press Enter, and then type the following code.

  ```cs
      [Required(ErrorMessage = "Please select the butterfly family")]
```

4. In the **Butterfly** code window, place the mouse cursor at the end of the **ButterflyFamily** property code, press Enter, and then type the following code.

  ```cs
      [Required(ErrorMessage = "Please select the butterfly quantity")]
```

5. In the **Butterfly** code window, place the mouse cursor at the end of the **Quantity** property code, press Enter, and then type the following code.

  ```cs
      [Required(ErrorMessage = "Please type the characteristics")]
```

6. In the **Butterfly** code window, place the mouse cursor at the end of the **CreatedDate** property code, press Enter, and then type the following code.
...
2. In the **Create** action code block created with HTTP verb POST, locate the following code.
...
3. Place the mouse cursor before the located code, and type the following code.
  ...
  ```cs
       ...
       {
```
4. In the **Create** action code block created with HTTP verb POST, select the following code.
...
10. Place the mouse cursor at the end of the **MaxButterflyQuantityValidation** method code block, press Enter, type the following code, and then press Enter.
...
13. In the **Butterfly** code window, place the mouse cursor at the end of the **ButterflyFamily** property code, press Enter, and then type the following code.
...
10. On the **Submit Personal Information** correct the **Butterflies Quantity** field with the custom validation message, type 2, and then click **Submit**. 

11. On the **Butterflies Shop** page, Verify the newly submitted butterfly details.

12. In the Microsoft Edge window, click **Close**.

13. On the **DEBUG** menu of the **ButterfliesShop (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.

14. In the **"ButterfliesShop - Microsoft Visual Studio"** window, click **Close**.

...
2. Ensure that the cursor is at the end of the **Create** action code block with **HTTP GET** verb, press Enter, and then type the following code.
...
```
4. In the **Create** action code block created with **HTTP POS** verb, immediately after the code you just added, press Enter, and type the following code.
...
4. In the **BODY** element of the **Create.cshtml** code window, type the following code.
...
1. In the **Create.cshtml** code window.
...
6. In the **Butterfly.cs** code window, place the mouse cursor at the end of the **Characteristics** property code, and press Enter twice.
...
```
8.  In the **Butterfly.cs** code window, place the mouse cursor at the end of the **PhotoAvatar** property code, and press Enter.
...
4. On the **Add Butterflies to The Shop** page, leave all the fields blank, and click the **Submit** button.
...
8.  Append the following code to the existing line of code.
  ...
  ```cs
      : ValidationAttribute
```
9. In the **MaxButterflyQuantityValidation.cs** code block, press Enter, and type the following code.

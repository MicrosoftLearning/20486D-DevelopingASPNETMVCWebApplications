...
11. Place the cursor before the located code, press Enter, and then type the following code:
  ```cs
       [Authorize]
```  
...
11. On the **Register** page, in the **Role Name** list, select **Administrator**,_ and then click **Register**.
...
12. On the **Workers Portal** page, click **Add Book to the Library**.

13. On the **Workers Portal** page, in the **Genre** list, select _&lt;A genre of your choice&gt;._

14. On the **Register** page, in the **Name** text box, type _&lt;A name of your choice&gt;._

15. On the **Register** page, in the **Author** text box, type _&lt;An author of your choice&gt;._

16. On the **Register** page, in the **Date Published** text box, type _&lt;a date time of your choice&gt;._

17. On the **Register** page, in the **Photo** box, import an image from **Allfiles\Mod11\Labfiles\Image\book.jpg**, and then click **Add a Book**.
...
11. On the **Register** page, in the **Role Name** list, select **Member**,_ and then click **Register**.
...
```
6. Place the cursor before the located code, press Enter, and then type the following code:
  ```cs
       [ValidateAntiForgeryToken]
``` 
7. In the **Library - Microsoft Visual Studio** window, in **Solution Explorer**, under **Controllers**, and then click **LibraryController.cs**.
...
4. On **Cross-Site Request Forgery Attack** page, click **Attack**.
      ...
      >**Note:** Examine the page, 404 error message was thrown.

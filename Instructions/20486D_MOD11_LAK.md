...
19. In the menu bar, click **Logout**.

20. In the menu bar, click **Login**.

21. On the **Login** page, click **Register**.

22. On the **Register** page, in the **First Name** text box, type _&lt;A first name of your choice&gt;._

23. On the **Register** page, in the **Last Name** text box, type _&lt;A last name of your choice&gt;._

24. On the **Register** page, in the **Phone Number** text box, type _&lt;A phone number of your choice&gt;._

25. On the **Register** page, in the **Email** text box, type _&lt;An email time of your choice&gt;._

26. On the **Register** page, in the **User Name** text box, type _&lt;A user name of your choice&gt;._

27. On the **Register** page, in the **Password** text box, type _&lt;123qwe!@#QWE&gt;._

28. On the **Register** page, in the **Role Name** list, select **Member**, and then click **Register**.

29. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]/Librarian/Index**, and then press Enter.

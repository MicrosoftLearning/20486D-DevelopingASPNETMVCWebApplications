...
8. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.
...
10. Place the cursor after the located code, press Enter twice, and then type the following code:
  ```cs
       app.UseStaticFiles();
...
11. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Zoo**, point to **Add**, and then click **New Folder**.

12. In the **NewFolder** box, type **Middleware**, and then press Enter.

13. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Middleware**, point to **Add**, and then click **Class**.

14. In the **Add New Item – Zoo** dialog box, in the **Name** text box, type **ApplicationBuilderExtensions**, and then click **Add**.
...
22. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml**.

23. In the **_Layout.cshtml** code window, locate the following code:
  ```cs
       <link type="text/css" rel="stylesheet" href="~/css/zoo-style.css"/>
```

24. Place the cursor after the **>** (greater than) sign, press Enter, and then type the following code: 
  ```cs

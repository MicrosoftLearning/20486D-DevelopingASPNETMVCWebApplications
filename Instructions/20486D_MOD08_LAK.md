...
6. In the **Select a Layout Page** dialog box, under **Project folders**, expand **Views**, and then select **Shared**.
...
```
3. Place the cursor after the **}** (closing braces) sign, press Enter twice, and then type the following code:
  ```cs
       .nav {
...
```
4. Place the cursor immediately after the last typed **}** (closing braces) sign, press Enter twice, and then type the following code:
  ```cs
       .nav li a {
          display: block;
          color: white;
...
```
2. Place the cursor after the **}** (closing braces) sign, press Enter twice, and then type the following code:
  ```cs
       .photo-index-card {
...
9. Place the cursor after the **{** (opening braces) sign of the typed code, press Enter, and then type the following code: 
  ```cs

...
4. In the **Zoo (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
...
1. In the **Zoo - Microsoft Visual Studio** window, in the **Solution Explorer**, under **wwwroot**, under **css**, click **zoo-style**.
...
20. In the **ApplicationBuilderExtensions.cs** code block, place the cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
...
```
4. Select all the **calculateSum** function code block.
...
8. Place the cursor before the **calculateSum** function code block, press Enter, and then type the following code: 
  ```cs
...
12. Place the cursor after the **>** (greater than) sign, press Enter, and then type the following code: 
  ```cs
...
19. On the **FILE** menu of the **Zoo - Microsoft Visual Studio** window, click **Save All**.

20. On the **DEBUG** menu of the **Zoo - Microsoft Visual Studio** window, click **Start Debugging**.
      
21. In the **Microsoft Edge** window, click **Close**.

22. On the **DEBUG** menu of the **ZOo (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.

23. On the **FILE** menu of the **Zoo - Microsoft Visual Studio** window, click **Exit**.

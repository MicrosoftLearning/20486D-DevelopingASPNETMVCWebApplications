...
1. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, right-click **ZooSite**, click **Add**, and then click **Existing Item**.
...
3. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **wwwroot**, right-click **css**, click **Add**, and then click **Existing Item**.

4. In the **Add Existing Item - Zoo** dialog box, go to **Allfiles\Mod08\Labfiles\ZooCSS**, click **zoo-style.css**, and then click **Add**.

5. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **wwwroot**, under **css**, click **zoo-style.css**, and examine the file content.
...
2. On the **DEBUG** menu of the **Zoo - Microsoft Visual Studio** window, click **Start Without Debugging**.
...
12. On the **FILE** menu of the **Zoo - Microsoft Visual Studio** window, click **Exit**.

...
10. On **Step 2 - Buy Tickets**, in the **Email** box, type _&lt;abcd&gt;._
...
3. On the **Zoo Attractions** page, in the **Welcome to Zoo Center** header click **right arrow**, and then click **left arrow**.

    >**Note:** The browser displays the **header** with the slider, and the slider functionality is applied by a **JavaScript File** named **slider-functions**.
...
11. On **Step 2 - Buy Tickets**, in the **Email** box, correct the field, and type _&lt;An email of your choice&gt;._

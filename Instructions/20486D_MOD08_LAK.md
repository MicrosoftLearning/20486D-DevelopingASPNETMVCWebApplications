...
4. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, expand **ZooSite**, click **Index.cshtml**.
...
5. In the **Add New Item – Zoo** dialog box, in the result pane, click **JavaScript File**, and then click **Add**.
...
8. Place the cursor after the first **{** (opening braces) sign of the **Configure** method, press Enter, type the following code, and then press Enter.
  ```cs
       app.UseStaticFiles();
...
9. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Zoo**, point to **Add**, and then click **New Folder**.

10. In the **NewFolder** box, type **Middleware**, and then press Enter.

11. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Middleware**, point to **Add**, and then click **Class**.

12. In the **Add New Item – Zoo** dialog box, in the **Name** text box, type **ApplicationBuilderExtensions**, and then click **Add**.
...
19. In the **ApplicationBuilderExtensions.cs** code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
...
20. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml**.

21. In the **_Layout.cshtml** code window, locate the following code:
  ```cs
       <link type="text/css" rel="stylesheet" href="~/css/zoo-style.css"/>
```

22. Place the cursor after the **>** (greater than) sign, press Enter, and then type the following code: 
  ```cs
...
8. Ensure that the cursor is after the **{** (opening braces) sign, press Enter, and then type the following code:
  ```cs
...
5. On **Step 1 - Choose Tickets**, in the **Adult** box, select _&lt;as many tickets as you like&gt;,_ and then in the **Senior** box, select _&lt;as many tickets as you like&gt;._ 

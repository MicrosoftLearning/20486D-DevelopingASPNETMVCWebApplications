...
5. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **wwwroot**, under **css**, click **zoo-style.css**.
...
7. Wait for the **Microsoft Visual Studio** dialog box to appears, and then click **Yes to All**.

    >**Note:** In **Solution Explorer**, under **Depenndencies**, a new folder named **npm** has been added which contains the **jquery** package.

8. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, in **Explorer Toolbar Options** click **Show All Files**.
...
18. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.

19. In the **Startup.cs** code window, locate the following code:
  ```cs
       using Zoo.Data;
```
20. Ensure that the cursor is at the end of the **Zoo.Data** namespace, press Enter, and then type the following code:
  ```cs
...
23. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
6. In the **Zoo – Microsoft Visual Studio** window, in **Solution Explorer**, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.

7. In the **Add New Item – Zoo** dialog box, click **Web**, and then, in the result pane, click **JavaScript File**.

8. In the **Add New Item – Zoo** dialog box, in the **Name** text box, type **menubar-functions**, and then click **Add**.
...
10. In the **Zoo – Microsoft Visual Studio** window, in **Solution Explorer**, under **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.

11. In the **Add New Item – Zoo** dialog box, click **Web**, and then, in the result pane, click **JavaScript File**.

12. In the **Add New Item – Zoo** dialog box, in the **Name** text box, type **slider-functions**, and then click **Add**.
...
```
14. In the **Zoo – Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
1. In the **Zoo – Microsoft Visual Studio** window, in **Solution Explorer**,click **package.json**.
...
```
4. In the **Zoo - Microsoft Visual Studio** window, on the **FILE** menu, click **Save package.json**.

    >**Note:** In **Solution Explorer**, under **Depenndencies**, under **npm** new packages has been added named **jquery-validation**, and **jquery-validation-unobtrusive**.

5. In the **Zoo - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **ZooSite**, click **BuyTickets.cshtml**.

6. In the **BuyTickets.cshtml** code window, locate the following code:
  ```cs
       @section Scripts{
           <script src="~/js/form-functions.js"></script>
       }
```
7. Place the cursor after the **{** (opening brace) sign, press Enter, and then type the following code: 
  ```cs

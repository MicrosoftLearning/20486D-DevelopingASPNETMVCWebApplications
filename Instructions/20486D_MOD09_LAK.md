...
5. In **Task Runner Explorer**, under **Tasks**, right-click **min:js**, and then click **Run**.
      ...
      >**Note:** In **Solution Explorer**, under **wwwroot**, a new folder named **script** with a file named **script.min.js**. The **script.min.js** file is a minified version of the **payment-calc.js** file. 

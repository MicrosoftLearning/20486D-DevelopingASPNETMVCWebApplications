...
4. In the **Start Page - Microsoft Visual Studio** window, on the **FILE** menu, point to **Open**, and then click **Project/Solution**.

5. Navigate to **Allfiles\Mod09\Labfiles\01_IceCreamCompany_begin**, and then double-click **IceCreamCompany.sln**.

6. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **Tools** menu, click **Options**.
...
9. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **IceCreamCompany**, point to **Add**, and then click **New Item**.
...
```
14. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Save package.json**.
...
```
5. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

#### Task 3: Run the task

1. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **gulpfile.js**, and then click **Task Runner Explorer**.
...
6. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.
...
1. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**,  click **package.json**.
...
3. Replace the selected code with the following code:
  ```cs
       ...
       "gulp-cssmin": "0.2.0"
```
4. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Save package.json**.

    >**Note:** In **Solution Explorer**, under **Depenndencies**, under **npm** a new packages added named **gulp-sass**, and **gulp-cssmin**.

5. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**,  click **gulpfile.js**.
...
1. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml**.
...
```
4. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.
...
2. In the **IceCreamCompany - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**.
...
13. In the **IceCreamCompany (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.

...
3. In **Task Runner Explorer**, under **Tasks**, right-click **min-vendor:js**, and then click **Run**.
      ...
      >**Note:** In **Solution Explorer**, under **wwwroot**, under **lib**, a new **vendor.min.js** file has been added.

4. In **Task Runner Explorer**, under **Tasks**, right-click **min:js**, and then click **Run**.

      >**Note:** In **Solution Explorer**, under **wwwroot**, under **script**, a new **script.min.js** file has been added.
...
10. Navigate to **Allfiles\Mod09\Labfiles\Views**, open **BuycshtmlFirst.txt**, and then copy all the file content.
...
2. Navigate to **Allfiles\Mod09\Labfiles\Views**, open **BuycshtmlSecond.txt**, and then copy all the file content.

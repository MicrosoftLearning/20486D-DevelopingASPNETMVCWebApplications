...
1. Navigate to **Allfiles\Mod09\Labfiles\01_IceCreamCompany_begin\IceCreamCompany**.
...
5. On the taskbar, click **File Explorer**, navigate to **Allfiles\Mod09\Labfiles\01_IceCreamCompany_begin** and then double-click **IceCreamCompany.sln**.
...
9. In the **IceCreamCompany - Microsoft Visual Studio** window, in **Solution Explorer**, click **package.json**.

10. Examine the **package.json** code window.

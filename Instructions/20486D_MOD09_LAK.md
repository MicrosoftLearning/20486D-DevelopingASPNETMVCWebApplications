...
15. Navigate to **Allfiles\Mod09\Labfiles\Views**, open **BuyViewFirst.txt**, and then copy all the file content.
...
19. Navigate to **Allfiles\Mod09\Labfiles\Views**, open **BuyViewSecond.txt**, and then copy all the file content.

...
23. Click Visual C#, then click **WPF App (.Net framework)**, click on the project name text box, then type **DesignProject**, and then press **OK**.
...
32. Right click the **Photo** class, click **Add** then click **Property**, and name it **PhotoID**.

33. Right click the **Photo** class, click **Add** then click **Property**, and name it **Title**.
...
37. Right click the **Photo** class, click **Add** then click **Property**, and name it **PhotoFile**.
...
39. Right click the **Photo** class, click **Add** then click **Property**, and name it **Description**.
...
41. Right click the **Photo** class, click **Add** then click **Property**, and name it **CreatedDate**.

42. Under the **Class Details** window, find the property named **CreatedDate**, and change its corresponding type, to **object**.

43. Right click the **Photo** class, click **Add** then click **Property**, and name it **Owner**.

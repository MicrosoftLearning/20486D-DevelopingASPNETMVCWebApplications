...
1. Go to **https://github.com/MicrosoftLearning/20486D-DevelopingASPNETMVCWebApplications/tree/master/Allfiles/Mod02/Labfiles/01_DesignProject_begin** and double-click **InitialInvestigation.docx**.

2. In the **InitialInvestigation.docx - Microsoft Word** window, in the **View** tab, in the **Show** section, ensure that the **Navigation Pane** check box is selected.
...
6. In the **InitialInvestigation.docx - Microsoft Word** window, review **Figure 1: Use Case Summary**.

7. In the **InitialInvestigation.docx - Microsoft Word** window, click **Close**.
...
26. In the **Location** box, ensure that the location specified is **Allfiles\20486D\20486D\Mod02\Labfiles**, and then click **OK**.
...
34. In Solution Explorer, click **ModelDesign.cd**. 
...
46. Right-click the **Comment** class, select **Add**, select **Property**, and name it **Owner**.
...
22. In the new window that opened, click the **Name** box, type **Comment**, and then click **OK**.
...
30. In **Solution Explorer**, click **ModelDesign.cd**.
...
36. On the **Class Details - Comment** pane of the **Comment** class, find the **Subject** property, and in the corresponding **Type** box, type **string**.

37. In the **Class Designer** window, right-click the **Comment** class, select **Add**, select **Property**, and in then name it **Body**.
...
41. Within the **Owner** property code block, select the following code:
```cs
    get => default(int);
```
...
19. In the **DetailedPlanningDocument.docx - Word** window, in the **FILE** menu, click **Save**.
...
49. In the **Add Existing Item – DesignProject** dialog box, in the file type list, select __All Files (*.*)__, go to the following path **Allfiles\Mod02\Labfiles\01\_DesignProject\_begin**, select the **photo.jpg** file, and then click **Add**.
...
89. In the **Properties** window, under the **Common** category, change the value of the **Content** box to **Add a Comment**.
...
4. In the **Add New Item – DesignProject** dialog box, in the **Name** box, type **PhotoGalleryView**, and then click **Add**.

5. In the **Document Outline** window, click the **[Window]** row.

6. In the **Properties** window, verify that near the **Type** text, the word **Window** is shown.

7. Under the **Layout** category, click **Width**, and type **500**.

8. Under the **Layout** category, click **Height**, and type **600**.

9. In the **Properties** window, under the **Appearance** category, change the **WindowStyle** to **None**.

10. From the toolbox, drag a label to the top left-hand side corner of the **Class Designer** window.

11. In the **Properties** window, under the **Common** category, change the value of the **Content** box to **Adventure Works Photo Sharing**.

12. In the **Properties** window, under the **Text** category, change the text size to **20 px**.

13. In Solution Explorer, click **SinglePhotoView.xaml**.

14. In the **Class Designer** window, right-click the top canvas, and then select **Copy**.

15. In Solution Explorer, click **PhotoGalleryView.xaml**. 

16. In the **Class Designer** window, in the designed window, right-click an empty area, and then click **Paste**.

17. From the toolbox window, drag another canvas, and place it below the previous canvas, over the left-hand side of the window. 

18. In the **Properties** window, under the **Brush** category, click in the **Background** text to select this line.

19. Below the **Background** line, there are five tabs. Place the mouse pointer over a tab to see its name.

20. Click the **Solid color brush** tab. Ensure that the **Background** line is still selected.

21. Next to the color picker box, there are four text boxes.

22. In the **R** box, type **150**.

23. In the **G** box, type **175**.

24. In the **B** box, type**207**.

25. Under the **Layout** category, in the **Width** box, type **150**.

26. Under the **Layout** category, in the **Height** box, type **190**.
...
28. In the **Properties** window, under the **Common** category, change the value of the **Content** box to **Title**.

29. Verify that the last created canvas is selected, from the toolbox, drag a label on to the canvas, and place the new label in the top left-hand corner of the canvas.

30. In the **Properties** window, under the **Common** category, change the value of the **Content** box to **By: Owner**.

31. Verify that the canvas is selected, from the toolbox, drag an image into the canvas and place the image below the labels.

32. In the **Properties** window, under the **Common** category, change the value of the **Source** box to **photo.jpg**, and press Enter.

33. Under the **Layout** category, in the **Width** box, type **100**.

34. Under the **Layout** category, in the **Height** box, type **100**.

35. Verify that the canvas is selected, from the toolbox, drag a label into the canvas and place the new label below the image.

36. In the **Properties** window, under the **Common** category, change the value of the **Content** box to **Created On: Date**.

37. Right-click the last created canvas, and select **Copy**.
...
39. Move the pasted canvas to the right-hand side of the original canvas.
...
42. In the **Class Designer** window, in the designed window, right-click an empty area, and then select **Paste**.    
>**Note**: Notice that the pasted canvas may cover the original canvas.

43. Move the pasted canvas to the left-hand side of the last pasted canvas.

44. In the **DesignProject - Microsoft Visual Studio** window, in the **FILE** menu, click **Save All**.
...
2. In the **InitialInvestigation.docx - Microsoft Word** window, click **Close**. 

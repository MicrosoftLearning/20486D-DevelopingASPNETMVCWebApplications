...
29. In the **Solution Explorer** pane, double click to open the file **ClassDiagram1.cd**.
...
32. Right click the **Comment** class, click **Add**, then click **Property**, and name it **CommentID**.

33. Right click the **Comment** class, click **Add**, then click **Property**, and name it **User**.

34. On the **Class Details - Photo** pane of the **Comment** class, find the property named **User**, click on its type under the Type column, and write **string**.

35. Right click the **Comment** class, click **Add**, then click **Property**, and name it **Subject**.

36. On the **Class Details - Photo** pane of the **Comment** class, find the property named **Subject**, click on its type under the Type column, and write **string**.

37. Right click the **Comment** class, click **Add**, then click **Property**, and name it **Body**.

38. On the **Class Details - Photo** pane of the **Comment** class, find the property named **Body**, click on its type under the Type column, and write **string**.

39. Right click the **Comment** class, click **Add**, then click **Property**, and name it **PhotoID**.
...
6. In the designer main window, click on the window title’s text header, and verify that in the properties window, near the below the name near **Type**, there is shown the word **Window**.

7. Below the **Type**, there is **Arrange By:**. Make sure it is set to **Arrange By: Category**.

8. In the **Properties** window, expand the **Layout** category.

9. In the **Width** textbox type 500, and in the **Height** textbox type 1100.

10. In the **Properties** window, under the **Appearance** category change the **WindowStyle** to **None**.

11. Drag a **Label** from the toolbox into the main window just below the left top corner.

12. Under the **Common** category in the **Properties** window, change the textbox value near the **Content** text, into **Adventure Works Photo Sharing**.

13. Under the **Text** category in the **Properties** window, change the text size into **20 px**.

14. Drag from the toolbox a **Canvas**, and put it just below the label (Aligned with the left side of the label).

15. In the **Properties** window, under the **Brush** category, click the **Background** text to select this line.

16. Below the **Background** line there are 5 tabs. Hovering on a tab shows its name.
...
22. Under the **Layout** category in the **Width** textbox, type 400.

23. Under the **Layout** category in the **Height** textbox, type 40.

24. Drag a **Button** from the toolbox, and place it into the left side of the **Canvas**.

25. In the **Properties** window, under the **Common** category, change the **Content** textbox value to **Home**.

26. Under the **Brush** category, click on the **Background** text to select this line.

27. Below the **Background** line, beside the color picker box, there are 4 textboxes.

28. Next to the **R**, in the textbox, Type 31.

29. Next to the **G**, in the textbox, Type 71.

30. Next to the **B**, in the textbox, Type 125.

31. Under the **Brush** category, click on the **Foreground** text to select this line.

32.  Below the **Foreground** line, beside the color picker box, there are 4 textboxes.

33. Next to the **R**, in the textbox, Type 255.

34. Next to the **G**, in the textbox, Type 255.

35. Next to the **B**, in the textbox, Type 255.

36. **Copy** the **Button**, and **Paste** it. It will apear just over the current button. Move it  to the right side of the current button.

37. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Gallery**.
...
39. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Add a Photo**.
...
41. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Slideshow**.

42. Drag a **Label** from the toolbox into the top left corner below the canvas you just pasted.

43. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **"Title"**.

44. In the **Properties** window, under the **Text** category, change the value of the text size textbox into the value of **"20 px"**.

45. Drag another **Label** from the toolbox into the main window just below the previous label.

46. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **By: Owner**.

47. In the Solution Explorer pane of the  **DesignProject – Microsoft Visual Studio window**, right-click on the  **DesignProject**  project file, point to  **Add**, and then click  **Existing item**.
    
48.  In the  **Add Existing Item – DesignProject**  dialog box, Change the file type drop box to show  **All Files (_._)**, go to this following path  **Allfiles\\Mod02\\Labfiles\\01\_DesignProject\_begin**, and select the  **NoImage.jpg**  file. and then click  **Add**.

49. Drag an **Image** from the toolbox into the main window just below the previous label.

50. In the **Properties** window, under the **Common** category, change the value of the **Source** textbox into  **NoImage.jpg**, and press **Enter**.

51. Resize the image so it will take most of the page width, and the photo will stay in the center.

52. Drag another **Label** from the toolbox into the main window just below the Image.

53. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Description**.

54. Drag another **Label** from the toolbox into the main window just below the other label you just added.

55. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Photo Description...**.

56. Under the **Layout** Category, click on the **Width** textbox, and type 300.

57. Under the **Layout** Category, click on the **Height** textbox, and type 150.

58. In the **Properties** window, under the **Brush** category, select the **BorderBrush** line.
Below it there are 5 tabs. Moving the mouse on each of them shows the tab name. Select the **Solid color brush** tab.

59. In the opened tab to the right of the color picker box, there are 4 textboxes with letters besides them.
In each of the **R** box, **G** box, and **B** box type the value of 0.

60. In the **Appearance** category, there is an arrow pointing down. Click on it, and near the **Border Thickness**, there are 4 textboxes. Type in each of them the value of 2.

61. Drag another **Label** from the toolbox into the main window just below the Image.

62. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Created On: Date**.

63. Drag another **Label** from the toolbox into the main window just below the Image.
...
75. Drag another **Label** from the toolbox into the canvas at the left top side.

76. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **From:**.

77. Drag another **Label** from the toolbox into the canvas at the left side just below the previous **Label**.

78. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Subject:**.

79. Drag another **Label** from the toolbox into the canvas at the left side just below the previous **Label**.
...
85. Below the **Foreground** line, there are 5 tabs. Moving the mouse on each of them shows the tab name. Select the **Solid color brush** tab.

86. Now select the **Solid Brush** tab below it.
...
1. In the  **DesignProject– Microsoft Visual Studio window**, in the  **Solution Explorer**  pane, right-click  **DesignProject**, point to  **Add**, and then click  **Window**.

2.  In the Add New Item –  **DesignProject**  dialog box, click  **Window (WPF)**.

3.  In the Name box of the  **Add New Item – DesignProject**  dialog box, type  **PhotoGalleryView**, and then click  **Add**.

4. Ensure that the **Properties** window is opened, if not, press **View**, and then **Properties Window**.

5. In the designer main window, click on the window title's text header.

6. In the **Properties** window, expand the **Layout** category.

7. In the **Width** textbox type 500, and in the **Height** textbox type 600.

8. Under **Appearance** category change the **WindowStyle** to **None** (which vanishes the window's header).

9. Drag a **Label** from the toolbox into the main window just below the left top corner.

10. Under the **Common** category in the **Properties** window, change the textbox value of the **Content** text, into **Adventure Works Photo Sharing**.

11. Under the **Text** category in the **Properties** window, change the text size into **20 px**.

12. In the **Solution Explorer** pane, double click the **SinglePhotoView.xaml**.

13. Select the top **Canvas** from the window, right click it, then press **Copy**.

14. In the **Solution Explorer** pane, double click the **PhotoGalleryView.xaml**, and right click the window, then click **Paste**.

15. From the toolbox window, drag another **Canvas**, and put it below the previous canvas, over the left side of the window. 

16. In the **Properties** window, under the **Brush** category, click in the **Background** text to select this line.

17. Below the **Background** line there are 5 tabs. Hovering on a tab show's its name.
...
23. Under the **Layout** category in the **Width** textbox, type 150.

24. Under the **Layout** category in the **Height** textbox, type 190.

25. Drag a **Label** from the toolbox into the top left corner of the canvas you just added.

26. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **"Title"**.

27. Drag another **Label** from the toolbox into the canvas just below the previous label.

28. On the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **By: Owner**.

29. Drag an **Image** from the toolbox into the canvas just below the previous label.

30. On the **Properties** window, under the **Common** category, change the value of the **Source** textbox into **NoImage.jpg**, and press **Enter**.

31. Drag another **Label** from the toolbox into the canvas just below the Image you just added.

32. On the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Created On: Date**.

33. Copy the **Canvas**, and paste it to the right of the current canvas.

34. Paste another copy below it, and another one beside it.

35. In the Top Menu Click **Save**.

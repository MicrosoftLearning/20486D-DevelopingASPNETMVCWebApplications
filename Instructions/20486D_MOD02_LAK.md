...
16. In row number #5, at the **Data Types** column, type **DateTime**.
...
27. In the Solution Explorer pane of the  **DesignProject - Microsoft Visual Studio**  window, right-click **DesignProject**, point to **Add**, and then click  **New Item**.

28. In the navigation pane of the **Add New Item - DesignProject** dialog box, expend **Installed**, then expend **Visual C#**, and then click **General**.
    
29. In the  **General** category of the **Add New Item – DesignProject**  dialog box, click the **Class Diagram**.
    
30. In the  **Name**  box of the  **Add New Item – DesignProject**  dialog box, type  **ModelDesign**, and then click  **Add**.
 
31. If the toolbox window is not open, press **View**, and then press **Toolbox**.
...
44. On the **Class Details - Photo** pane, find the property named **CreatedDate**, and change its corresponding type, to **DateTime**.
...
24. In the **Solution Explorer** pane, click the **Photo.cs**.
...
29. Within the **Title** property code block, select the following code.
```cs
    get => default(int);
```
...
31. Within the **PhotoFile** property code block, select the following code.
```cs
    get => default(int);
```
...
33. Within the **Description** property code block, select the following code.
```cs
    get => default(int);
```
...
35. Within the **CreatedDate** property code block, select the following code.
```cs
...
37. Within the **Owner** property code block, select the following code.
```cs
    get => default(int);
```
...
39. In the **Solution Explorer** pane, click the **ModelDesign.cd**.

40. Notice there is a **PhotoComments** property under the **Photo** class, and that there is no association between the **Photo** and **Comment** classes.

41. Right click the **PhotoComments** property, and click the **Show as collection association**.
...
42. Inside the **Class Designer** widnow, right click the **Comment** class, click **Add**, then click **Property**, and name it **CommentID**.

43. Inside the **Class Designer** widnow, right click the **Comment** class, click **Add**, then click **Property**, and name it **User**.

44. On the **Class Details - Comment** pane of the **Comment** class, find the property named **User**, click on its type under the Type column, and write **string**.

45. Inside the **Class Designer** widnow, right click the **Comment** class, click **Add**, then click **Property**, and name it **Subject**.

46. On the **Class Details - Comment** pane of the **Comment** class, find the property named **Subject**, click on its type under the Type column, and write **string**.

47. Inside the **Class Designer** widnow, right click the **Comment** class, click **Add**, then click **Property**, and name it **Body**.

48. On the **Class Details - Comment** pane of the **Comment** class, find the property named **Body**, click on its type under the Type column, and write **string**.

49. Inside the **Class Designer** widnow, right click the **Comment** class, click **Add**, then click **Property**, and name it **PhotoID**.

50. In the **Solution Explorer** pane, click the **Comment.cs**.

51. Within the **Owner** property code block, select the following code.
```cs
    get => default(int);
```
...
53. Within the **Subject** property code block, select the following code.
```cs
    get => default(int);
```
...
55. Within the **Body** property code block, select the following code.
```cs
    get => default(int);
```
...
17. In the **Solution Explorer** pane, click the **PhotoGalleryView.xaml**, right click the window, then click **Paste**.

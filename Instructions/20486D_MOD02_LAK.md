...
36. Right click on the **Title** property we created, and select **Class Details**.
     ...
     >**Note:**  Notice that a class details window now opened. Also notice that the PhotoID property received by default the type of int.
...
20. Now drag another **Class** from the toolbox into the **Class Designer** window.

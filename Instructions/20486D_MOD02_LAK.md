...
12. In row 4, in the **Description** column, type **This action runs when the user clicks aמ “Add a Photo” link. The action creates a new instance of the Photo model class and passes it to the AddPhoto view.** 
...
18. In row 7, in the **Description** column, type **This action runs when the user clicks “Delete” in the DeletePhoto view. The action deletes the current פhoto, with its associated Comments, from the database and redirects the user to the DisplayGallery view.** 
...
5. On the **View** menu of the **DesignProject - Microsoft Visual Studio** window, click **Properties Window**.

6. On the **View** menu of the **DesignProject - Microsoft Visual Studio** window, point to **Other Windows**, and then click **Document Outline**
...
92. On the **FILE** menu of the **DesignProject - Microsoft Visual Studio** window, click **Save All**.
...
8. In the **Width** textbox type 500, and in the **Height** textbox type 600.

9. Under **Appearance** category change the **WindowStyle** to **None** (which vanishes the window's header).

10. Drag a **Label** from the toolbox into the **Class Designer** window, just below the left top corner.

11. Under the **Common** category in the **Properties** window, change the textbox value of the **Content** text, into **Adventure Works Photo Sharing**.

12. Under the **Text** category in the **Properties** window, change the text size into **20 px**.

13. In the **Solution Explorer** pane, click the **SinglePhotoView.xaml**.

14. Select the top **Canvas** from the window, right-click it, and then press **Copy**.

15. In the **Solution Explorer** pane, click the **PhotoGalleryView.xaml**. 

16. In the **Class Designer** window, right-click an empty area inside the designed window, and then click **Paste**.

17. From the toolbox window, drag another **Canvas**, and put it below the previous canvas, over the left side of the window. 
...
27. Verify that the last created canvas is selected, drag a **Label** from the toolbox into the top left corner of the canvas you just added.

28. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Title**.

29. Verify that the canvas is selected, drag another **Label** from the toolbox into the canvas just below the previous label.

30. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **By: Owner**.

31. Verify that the canvas is selected, drag an **Image** from the toolbox into the canvas just below the previous label.

32. In the **Properties** window, under the **Common** category, change the value of the **Source** textbox into **photo.jpg**, and press **Enter**.

33. Verify that the canvas is selected, drag another **Label** from the toolbox into the canvas just below the Image you just added.

34. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Created On: Date**.

35. Right-click on the last created canvas, and click **Copy**.

36. In the **Class Designer** window, right-click an empty area inside the designed window, then click **Paste**.
    >**Note**: Notice that the pasted **Canvas** covers the original canvas.

37. Move the pasted **Canvas** to the right side of the original canvas.

38. In the **Class Designer** window, right-click an empty area inside the designed window, then click **Paste**.
    >**Note**: Notice that the pasted **Canvas** covers the original canvas.

39. Move the pasted **Canvas** to bellow of the previous pasted canvas.

40. In the **Class Designer** window, right-click an empty area inside the designed window, then click **Paste**.
    >**Note**: Notice that the pasted **Canvas** covers the original canvas.

41. Move the pasted **Canvas** to left of the last pasted canvas.

42. On the **FILE** menu of the **DesignProject - Microsoft Visual Studio** window, click **Save All**.
...
2. On the **FILE** menu of the **DesignProject - Microsoft Visual Studio** window, click **Save All**.

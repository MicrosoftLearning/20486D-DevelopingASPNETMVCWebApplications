...
31. If the toolbox window to the left of the screen is not open, press **View**, and then press **ToolBox**.

32. Inside the toolbox there is an object list. If the list **Class Designer** is not open, press on it to display the list.

33. Drag the **Class** object from the toolbox into the main area.

34. In the **Class name** box of the **New Class** dialog box, type **Photo** and press **OK**.

35. Right click the **Photo** class, click **Add** then click **Property**, and name it **PhotoID**.

36. Right click the **Photo** class, click **Add** then click **Property**, and name it **Title**.

37. Now right click on the **Title** property we created, and select **Class Details**.
...
38. On the **Class Details - Photo** tab, under the properties header, there is a list of properties names. Now verify that the property with the name **Title** is selected.

39. Under the **Type** column there is a type of int. Click on it, and change it into **string**.

40. Right click the **Photo** class, click **Add** then click **Property**, and name it **PhotoFile**.

41. On the **Class Details - Photo** pane, under the properties header, find the **PhotoFile** property, click on its type under the Type column, and  change its corresponding type to **byte**.

42. Right click the **Photo** class, click **Add** then click **Property**, and name it **Description**.

43. On the **Class Details - Photo** pane, find the property named **Description**, double click, and change its corresponding type, to **string**.

44. Right click the **Photo** class, click **Add** then click **Property**, and name it **CreatedDate**.

45. On the **Class Details - Photo** pane, find the property named **CreatedDate**, and change its corresponding type, to **object**.

46. Right click the **Photo** class, click **Add** then click **Property**, and name it **Owner**.

47. On the **Class Details - Photo** pane, find the property named **Owner**, and change its corresponding type, to **string**.

...
38. In the **Class Designer** window, right-click an empty area inside the designed window, then click **Paste**.
    >**Note**: Notice that the pasted **Canvas** is above the original copied canvas.

39. Move the pasted **Canvas** to the right side of the original copied canvas.
...
43. Move the pasted **Canvas** to bellow of the original copied canvas.

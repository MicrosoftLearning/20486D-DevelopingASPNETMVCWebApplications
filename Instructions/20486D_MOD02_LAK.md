...
22. Inside the **Class Designer** widnow, Click on the **Association** type from the toolbox, click on the **Photo** class, and then on the **Comment** class.
...
5. Verify that the **Document Outline** window is opened. If not, then go to **View**, point to **Other Windows**, then click **Document Outline**

6. In **Document Outline** window, click on the "**[Window]**" row.

7.  In the **Properties** window, Verify that near the **Type** text, the word **Window** is shown..

8. In the **Properties** window, expand the **Layout** category.

9. In the **Width** textbox type 500, and in the **Height** textbox type 600.

10. Under **Appearance** category change the **WindowStyle** to **None** (which vanishes the window's header).

11. Drag a **Label** from the toolbox into the main window just below the left top corner.

12. Under the **Common** category in the **Properties** window, change the textbox value of the **Content** text, into **Adventure Works Photo Sharing**.

13. Under the **Text** category in the **Properties** window, change the text size into **20 px**.

14. In the **Solution Explorer** pane, double click the **SinglePhotoView.xaml**.

15. Select the top **Canvas** from the window, right click it, then press **Copy**.

16. In the **Solution Explorer** pane, double click the **PhotoGalleryView.xaml**, and right click the window, then click **Paste**.
...
30. On the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **By: Owner**.

31. Verify that the canvas is selected, drag an **Image** from the toolbox into the canvas just below the previous label.

32. On the **Properties** window, under the **Common** category, change the value of the **Source** textbox into **NoImage.jpg**, and press **Enter**.
...
34. On the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Created On: Date**.

35. Copy the **Canvas**, and paste it to the right of the current canvas.

36. Paste another copy below it, and another one beside it.

37. In the Top Menu Click **Save**.

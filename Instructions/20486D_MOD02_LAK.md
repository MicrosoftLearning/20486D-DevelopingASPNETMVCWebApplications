...
20. In the **Model Class** and **Description** column of the **Table 1: MVC Model** table, select rows #1 to #6, right-click, then click **Merge Cells**.
...
32. In the navigation pane of the **Add New Item - DesignProject** dialog box, expend **Installed**, then expend **Visual C#**, and then click **General**.
    
29. In the **General** category of the **Add New Item – DesignProject** dialog box, click the **WPF App (.NET Framework)**.
...
45. Right-click the **Comment** class, click **Add** then click **Property**, and name it **Owner**.
...
47. In the **Solution Explorer** pane, click the **Photo.cs**.

48. Within the **Title** property code block, select the following code.
```cs
    get => default(int);
```
...
29. In the **Solution Explorer** pane, click the **ModelDesign.cd**.
...
40. In the **Solution Explorer** pane, click the **Comment.cs**.
...
1. In the **Table 2: MVC Controllers** table, at the **Cntroller** column, In row number #8, below the **PhotoController **,type **CommentController**.

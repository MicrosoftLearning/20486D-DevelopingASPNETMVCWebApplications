...
26. Drag a **Button** from the toolbox, and place it into the left side of the **Canvas**.
...
64. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Created On: Date**.

65. Drag another **Label** from the toolbox into the main window just below the Image.

66. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Comments:**.

67. Drag a **Canvas** from the toolbox into the main window just below the last added **Label**.

68. Set the **Canvas** left side, just below the **Photo Description** label's left side.

69. In the **Properties** window, under the **Brush** category, click on the **Background** line.

70. Below the background, there are 5 tabs. Moving the mouse on each of them shows the tab name. Select the **Solid color brush** tab.

71. Beside the color picker, there are 4 textboxes.

72. Next to the **R**, in the textbox, Type 150.

73. Next to the **G**, in the textbox, Type 175.

74. Next to the **B**, in the textbox, Type 207.

75. Under the **Layout** Category, click on the **Width** textbox, and type 300.

76. Under the **Layout** Category, click on the **Height** textbox, and type 130.

77. Drag another **Label** from the toolbox into the canvas at the left top side.

78. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **From:**.

79. Drag another **Label** from the toolbox into the canvas at the left side just below the previous **Label**.

80. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Subject:**.

81. Drag another **Label** from the toolbox into the canvas at the left side just below the previous **Label**.

82. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox into the value of **Body:**.

83. Copy the **Canvas**, and paste it below the previous one.

84. Drag a **TextBlock** from the toolbox into the main window, under the second comment canvas.

85. In the **Properties** window, under the **Common** category, change the value of the **Content**  textbox into **Add a Comment**.

86. Under the **Brush** category, select the **Foreground** line.

87. Below the **Foreground** line, there are 5 tabs. Moving the mouse on each of them shows the tab name. Select the **Solid color brush** tab.

88. Now select the **Solid Brush** tab below it.

89. Beside the color picker, there are 4 textboxes.

90. Next to the **R**, in the textbox, Type 0.

91. Next to the **G**, in the textbox, Type 0.

92. Next to the **B**, in the textbox, Type 255.

93. Under the **Text** category, There is a **U** letter button with an underline below it. Press this **U** letter button.

94. In the Top Menu Click **Save**.

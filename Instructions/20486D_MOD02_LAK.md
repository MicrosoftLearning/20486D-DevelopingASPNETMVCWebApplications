...
9. On the **FILE** menu of the **DesignProject - Microsoft Visual Studio** window, click **Save All**.
...
13. Drag a **Label** from the toolbox into the main window below the left top corner.

14. In the Properties window, under the **Common** category,  change the textbox value near the **Content** text, to **Adventure Works Photo Sharing**.

15. Under the **Text** category in the **Properties** window, change the text size to **20 px**.

16. Drag a **Canvas** from the toolbox into the main window below the label (Aligned with the left side of the label).
...
26. Verify that the canvas is selected, drag a **Button** from the toolbox, into the left side of the **Canvas**.
...
39. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Gallery**.
...
41. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Add a Photo**.
...
43. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Slideshow**.

44. Drag a **Label** from the toolbox into the top left corner below the last canvas you pasted.

45. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Title**.

46. In the **Properties** window, under the **Text** category, change the value of the text size textbox to the value of **"20 px"**.

47. Drag another **Label** from the toolbox into the main window below the previous label.

48. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **By: Owner**.
...
50. In the **Add Existing Item – DesignProject** dialog box, change the file type drop box to show **All Files (*.*)**, go to this following path **Allfiles\Mod02\Labfiles\01\_DesignProject\_begin**, and select the **photo.jpg** file. and then click **Add**.

51. Drag an **Image** from the toolbox into the main window below the previous label.

52. In the **Properties** window, under the **Common** category, change the value of the **Source** textbox to **photo.jpg**, and press **Enter**.

53. Under the **Layout** category in the **Width** textbox, type 400.

54. Under the **Layout** category in the **Height** textbox, type 240.

55. Drag another **Label** from the toolbox into the main window below the left side of the Image.

56. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Description**.

57. Drag another **Label** from the toolbox into the main window below the other label you just added.

58. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Photo Description...**.

59. Under the **Layout** category, click on the **Width** textbox, and type 300.

60. Under the **Layout** category, click on the **Height** textbox, and type 150.

61. In the Properties window, under the **Brush** category, click the **BorderBrush** text to select this line.

62. Below the **BorderBrush** line there are 5 tabs. Hovering on a tab shows its name.

63. Click on the **Solid color brush** tab. Ensure that the BorderBrush line is still selected.

64. Beside the color picker, there are 4 textboxes.

65. Next to the **R**, in the textbox, Type 150.

66. Next to the **G**, in the textbox, Type 175.

67. Next to the **B**, in the textbox, Type 207.

68. In the **Appearance** category, there is an arrow pointing down. Click on it, and near the **Border Thickness**, there are 4 textboxes. Type in each of them the value of 2.

69. Drag another **Label** from the toolbox into the main window below the left side of the **Photo Description** label.

70. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Comments:**.

71. Drag a **Canvas** from the toolbox into the main window below the last added **Label**.

72. Set the **Canvas** left side, just below the **Photo Description** label's left side.

73. In the Properties window, under the **Brush** category, click the **Background** text to select this line.

74. Below the **Background** line there are 5 tabs. Hovering on a tab shows its name.

75. Click on the **Solid color brush** tab. Ensure that the Background line is still selected.

76. Beside the color picker, there are 4 textboxes.

77. Next to the **R**, in the textbox, Type 150.

78. Next to the **G**, in the textbox, Type 175.

79. Next to the **B**, in the textbox, Type 207.

80. Under the **Layout** category, click on the **Width** textbox, and type 300.

81. Under the **Layout** category, click on the **Height** textbox, and type 130.

82. Verify that the canvas is selected, drag a **Label** from the toolbox, into the left top side of the Canvas.

83. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **From:**.

84. Verify that the canvas is selected, drag a **Label** from the toolbox, into the Canvas, and place the new Label below the previous Label.

85. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Subject:**.

86. Verify that the canvas is selected, drag a **Label** from the toolbox, into the Canvas, and place the new Label below the previous Label.

87. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to the value of **Body:**.

88. Copy the **Canvas**, and paste it below the last copied canvas.

89. Drag a **TextBlock** from the toolbox into the main window, under last copied canvas.

90. In the **Properties** window, under the **Common** category, change the value of the **Content** textbox to **Add a Comment**.

91. In the Properties window, under the **Brush** category, click the **Foreground** text to select this line.

92. Below the **Foreground** line there are 5 tabs. Hovering on a tab shows its name.

93. Click on the **Solid color brush** tab. Ensure that the Foreground line is still selected.

94. Beside the color picker, there are 4 textboxes.

95. Next to the **R**, in the textbox, Type 0.

96. Next to the **G**, in the textbox, Type 0.

97. Next to the **B**, in the textbox, Type 255.

98. Under the **Text** category, There is a **U** letter button with an underline below it. Press this **U** letter button.

99. On the **FILE** menu of the **DesignProject - Microsoft Visual Studio** window, click **Save All**. 
...
13. In the **Solution Explorer** pane, click the **SinglePhotoView.xaml**.

14. Select the top **Canvas** in the **Class Designer** window, right-click it, and then press **Copy**.

15. In the **Solution Explorer** pane, click the **PhotoGalleryView.xaml**. 
...
38. In the **Class Designer** window, In the designed window right-click an empty area, and then click Paste.    >**Note**: Notice that the pasted **Canvas** may covers the original canvas.

39. Move the pasted **Canvas** to the right side of the original canvas.

40.  In the **Class Designer** window, In the designed window right-click an empty area, and then click Paste.    >**Note**: Notice that the pasted **Canvas** may covers the original canvas.

41. Move the pasted **Canvas** to bellow of the previous pasted canvas.

42. In the **Class Designer** window, right-click an empty area inside the designed window, then click **Paste**.    >**Note**: Notice that the pasted **Canvas** may covers the original canvas.

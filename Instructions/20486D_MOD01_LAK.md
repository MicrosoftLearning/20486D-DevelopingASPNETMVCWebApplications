...
1. In the **ActorsRazorPages – Microsoft Visual Studio** window, in the Solution Explorer pane, right-click on the **Pages** folder, point to **Add**, and then click **New Item**.
...
```
15. In the **ActorsRazorPages – Microsoft Visual Studio** window, in the Solution Explorer pane, right-click **Models** folder, right click, point to **Add** , and select  **Existing Item**, in the dialog box navigate to **Allfiles/Mod01/Labfiles/01_ActorsRazorPages_begin**, click **Data.cs**, and then click **Add**. note that the namespace project name identical to your project name.

16.  In the **ActorsRazorPages – Microsoft Visual Studio** window, in the Solution Explorer pane, click on the **wwwroot** folder, and then ,on the **images** folder, right click, point to **Add** , and select  **Existing Item**, in the dialog box navigate to **Allfiles/Mod01/Labfiles/01_ActorsRazorPages_begin/Images**, select all the images, and then click **Add**.

17. In the **ActorsRazorPages – Microsoft Visual Studio** window, in the Solution Explorer pane, right-click **Pages** folder, point to **Add** , and select **New folder** In the Name box of the New Folder , type **Actors**.
...
```
6. In the **CakeStoreApi  – Microsoft Visual Studio** window, in the Solution Explorer pane, right-click **Models** folder, right click, point to **Add** , and select  **Existing Item**, in the dialog box navigate to **Allfiles/Mod01/Labfiles/02_CakeStoreApi_begin**, click **Data.cs**, and then click **Add**. note that the namespace project name identical to your project name.
...
```
12. In the **AnimlasMvc  – Microsoft Visual Studio** window, in the Solution Explorer pane, right-click **Models** folder, right click, point to **Add** , and select  **Existing Item**, in the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalsMvc_begin**, click **Data.cs**, and then click **Add**. note that the namespace project name identical to your project name.
...
19. In the **AnimlasMvc  – Microsoft Visual Studio** window, in the Solution Explorer pane, click on the **wwwroot** folder, and then ,on the **images** folder, right click, point to **Add** , and select  **Existing Item**, in the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalsMvc_begin/Images**, select all the images, and then click **Add**.

...
37. In the **ul** element code block, ensure that the cursor is before the **&lt;/ul&gt;** and type the following code.
...
7. On the **DEBUG** menu of the **CakeStoreApi –  Microsoft Visual Studio** window, click **Start Debugging**.
    ...
    >**Note:** The browser displays array of strings.
...
15. In the **Controller name** text box of the **Add Controller** dialog box, type **CakeStoreApiController**.
...
```
9. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window, right-click on the **Models** folder, point to **Add**, and then click **class**.

10. In the **Name** box of the **Add New Item – AnimlasMvc** dialog box, type **Animal**, and then click **Add**.
...
12. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window, right-click on the **Models** folder, point to **Add**, and then click **New Item**. 

13. In the **Add New Item - AnimlasMvc** click **Interface**. 

14. In the **Name** box of the **Add New Item – AnimlasMvc** dialog box, type **IData**, and then click **Add**.
...
```
17. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window,right-click on the **Models** folder, point to **Add**, and then click **Existing Item**.

18. In the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalsMvc_begin**, click **Data.cs**, and then click **Add**. note that the namespace project name identical to your project name.

19. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window, right-click  on the **Models** folder, point to **Add**, and then click **Class**.

20. In the **Name** box of the **Add New Item – AnimlasMvc** dialog box, type **IndexViewModel**, and then click **Add**.
...
22. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window,right-click **Controllers**, point to **Add**, and then click **Controller** 

23. In the **Template** list, click **MVC Controller - Empty** 

24. In the **Controller name** text box of the **Add Controller** dialog box, type  **AnimalsController**.
...
28. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window, expend **wwwroot** folder, right click on the **images** folder, point to **Add**, and then click  **Existing Item**.

29. In the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalsMvc_begin/Images**, select all the images, and then click **Add**.
...
41. In the **_Layout.cshtml** code window, in the **ul** element, type the following code.
  ```cs
        <li><a asp-area="" asp-controller="Animals" asp-action="Index">Animals</a></li>
```
42. In the Solution Explorer pane of the **AnimlasMvc  – Microsoft Visual Studio** window, click **Startup.cs**.

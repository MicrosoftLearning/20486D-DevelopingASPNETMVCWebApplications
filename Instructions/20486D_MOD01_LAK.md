...
12. In the **Actor.cs** code block, place the mouse cursor after the **{** second (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
17. In the **IData** interface code block, place the mouse cursor after the **{** second (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
5. In the **CakeStore.cs** code block, place the mouse cursor after the **{** second (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
```
17. In the **CakeStoreApiController.cs** code block, place the mouse cursor after the **{** second (opening brackets) sign, press Enter, type the following code, and then press Enter again.

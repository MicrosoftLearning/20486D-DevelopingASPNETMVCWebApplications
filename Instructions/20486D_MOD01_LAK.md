...
7. Place the mouse cursor before the **&lt;/ul&gt;**, press Enter, press the Up Arrow key, and then type the following code:
...
12. In the **Actor.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
29. In the **Index.cshtml.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
39. Place the mouse cursor before the **&lt;/ul&gt;**, press Enter, press the Up Arrow key, and then type the following code:
...
3. In the **Microsoft Edge** window, in the navigation bar click **Test Page**  to view its content.
    ...
    >**Note:** The browser window displays the title **TestPage**, and the text &quot;This is a Test Page&quot;. 
...
2. Place the mouse cursor after the **}** (closing brackets) sign of the located code, press Enter, type the following code, and then press Enter again.
...
```
10. Place the mouse cursor before the **&lt;/ul&gt;**, press Enter, press the Up Arrow key, and then type the following code:
...
13. In the **Animal.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
18. In the **IData** interface code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
20. In the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalMvc_begin**, click **Data.cs**, and then click **Add**.
...
23.  In the **IndexViewModel.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
29. In the **AnimalsController.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
31. In the dialog box navigate to **Allfiles/Mod01/Labfiles/03_AnimalMvc_begin/Images**, select all the images, and then click **Add**.
...
```
44. Place the mouse cursor before the **&lt;/ul&gt;**, press Enter, press the Up Arrow key, and then type the following code:

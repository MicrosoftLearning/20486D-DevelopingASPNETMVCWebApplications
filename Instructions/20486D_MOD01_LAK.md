...
7. In the result pane of the **New ASP.NET Core Web Application** dialog box click **Web Application**, and then click **OK**.
...
5. In the **_ViewStart.cshtml** code window, note that the value of Layout is **"_Layout"** .
...
7. In the **Contact.cshtml** code window, examine the Razor code, and note that there are no links to .css files.

8. In the Solution Explorer pane, under **Pages**, click  **_Layout.cshtml**.

9. In the **_Layout.cshtml** code window, in the **HEAD** element, note that there is a link to **~/css/site.css**.

10. In the Solution Explorer pane, under **ActorsRazorPages**, expand **wwwroot**, and then expand **css**.

11. In the Solution Explorer pane, under **ActorsRazorPages**, and under **css**, click **site.css**.
...
9. In the Solution Explorer pane, type **Models**, and then press Enter.
...
12. In the **Actor** class code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
16. In the **IData** interface code block place the mouse cursor before the word **interface**, and type **public**.

17. In the **IData** interface code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
```
18. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, right-click on the **Models**, point to **Add**, and select  **Existing Item**.
...
20. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window,  expend **wwwroot**, right click on the **images**, point to **Add**, and then click  **Existing Item**.
...
22. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window,  right-click **Pages**, point to **Add**, and select **New folder**.

23. In the Solution Explorer pane, type **Actors**, and then press Enter.

24. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, expend **pages**, right-click on **Actors**, point to **Add**, and then click **New Item**. 

25. In the **Add New Item - ActorsRazorPages** dialog box, click **Web**, and then, in the result pane, click **Razor Page**.

26. In the **Name** box of the **Add New Item – ActorsRazorPages** dialog box, type **Index.cshtml**, and then click **Add**.
...
```
29. In the **Index.cshtml.cs** class code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
30. In the **Index.cshtml** code window of the **ActorsRazorPages – Microsoft Visual Studio** window, replace the content **bellow** @model line  with the following code.
...
31. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, expand **Pages**, right click on the **Actors**, point to **Add**, and then click  **Existing Item**.
...
37. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, expand **pages**, double-click  **_Layout.cshtml**.
...
5. In the **Actors** window, click on **Details** to go to the details page.
...
4. In the Solution Explorer pane of the **CakeStoreApi - Microsoft Visual Studio** window, click **Controllers**, and then click  **ValuesController.cs**.
...
2. In the Solution Explorer pane, type **Models**, and then press Enter.
...
5. In the **CakeStore** class code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
9. In the **IData** class code block, place the mouse cursor before the word **interface**, and then type **public**.

10. In the **IData** class code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
```
17. In the **CakeStoreApiController** class code block, place the cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
...
5. In the **_ViewStart.cshtml** code window, note that the value for Layout is **"_Layout";**.
...
9. In the **_Layout.cshtml** code window, note that in the **HEAD** element there is a link to **~/css/site.css**.

10. In the Solution Explorer pane, expand **wwwroot**, and then in the **css** click **site.css**.

11. In the **site.css** code window, note that the style sheet for **_Layout.cshtml** displays.
...
2. Place the mouse cursor after the located code, type the following code, and then press Enter.
...
6. In the **TestPage.cshtml** **below**  the **H2** element  code window, type the following code.
...
```
9. In the Solution Explorer pane of the **AnimalsMvc  – Microsoft Visual Studio** window, right-click on the **Models**, point to **Add**, and then click **class**.

10. In the **Name** box of the **Add New Item – AnimalsMvc** dialog box, type **Animal**, and then click **Add**.
    
11. In the **Animal** class code block, press Enter, and then type the following code.
...
16. In the **IData** interface code block, press Enter, and then type the following code.
...
21.  In the **IndexViewModel** class code block, press Enter, and then type the following code.
...
27. In the **AnimalsController.cs** class code block, press Enter, and then type the following code.
...
8.  On the **DEBUG** menu of the **AnimalsMvc – Microsoft Visual Studio** window, click **Stop Debugging**.

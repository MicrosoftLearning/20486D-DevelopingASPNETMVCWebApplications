...
10. In the **IData.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
...
13. In the **Animal.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
...
18. In the **IData** interface code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
...
23.  In the **IndexViewModel.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
  ```cs
...
29. In the **AnimalsController.cs** code block, place the mouse cursor after the **{** (opening brackets) sign, press Enter, and then type the following code:
  ```cs

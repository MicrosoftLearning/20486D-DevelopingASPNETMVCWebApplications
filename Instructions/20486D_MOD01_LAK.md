...
5. In the **Name** text box, type **ActorsRazorPages**.

6. Replace the content in the **Location** box with **Allfiles\Mod01\Labfiles\01_ActorsRazorPages_begin**, and then click **OK**.

7. In the **New ASP.NET Core Web Application - ActorsRazorPages** dialog box, in the result pane, click **Web Application**, and then click **OK**.

8. In the **ActorsRazorPages –  Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**.

9. In **Microsoft Edge**, in the navigation bar, click **Contact** to review its content.

10. In **Microsoft Edge**, click **Close**.

11. In the **ActorsRazorPages (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.
 
#### Task 2: Exploring the application structure

1. In the **ActorsRazorPages – Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.
...
4. In the **ActorsRazorPages - Microsoft Visual Studio** window, in **Solution Explorer**, expand **Pages**, and then click  **_ViewStart.cshtml**.
...
6. In **Solution Explorer**, under **Pages**, click **Contact.cshtml**.

7. In the **Contact.cshtml** code window, examine the Razor code, and verify that there are no links to .css files.

8. In **Solution Explorer**, under **Pages**, click  **_Layout.cshtml**.

9. In the **_Layout.cshtml** code window, in the **HEAD** element, note that is a link to **~/css/site.css**.

10. In **Solution Explorer**, under **ActorsRazorPages**, expand **wwwroot**, expand **css**, and then click **site.css**

    >**Note:** This is the CSS **style sheet** file that applied in the **Layout.cshtml**.

#### Task 3: Adding simple functionality
...
5. In the **ActorsRazorPages – Microsoft Visual Studio** window, in **Solution Explorer**, expand **Pages**, and then click  **_Layout.cshtml**.
...
13. In the **ActorsRazorPages – Microsoft Visual Studio** window, right-click  **Models**, point to **Add**, and then click **New Item**.
...
26. In the **Add New Item – ActorsRazorPages** dialog box, in the **Name** text box, type **Index**, and then click **Add**.
...
30. In the **ActorsRazorPages – Microsoft Visual Studio** window, in the **Index.cshtml** code window, replace the content below **@model line** with the following code:
...
31. In the **ActorsRazorPages – Microsoft Visual Studio** window, in **Solution Explorer**, under **Pages**, right-click **Actors**, point to **Add**, and then click  **Existing Item**.

32. In the dialog box, navigate to **Allfiles\Mod01\Labfiles\01_ActorsRazorPages_begin\Pages**, select **Details.cshtml.cs** and **Details.cshtml**, and then click **Add**. 

    >**Note:** Examine the **Details.cshtml.cs**, and the **Details.cshtml** files content.

33. In the **ActorsRazorPages – Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.

34. Place the cursor at the end of the **using Microsoft.Extensions.DependencyInjection** namespace code, press Enter, and then type the following code:
...
36. Place the cursor before the located code, type the following code, and then press Enter.
...
5. In the **Name** text box, type **CakeStoreApi**.

6. In the **Location** box, replace its content with **Allfiles\Mod01\Labfiles\02_CakeStoreApi_begin**, and then click **OK**.

7. In the **New ASP.NET Core Web Application - CakeStoreApi**  dialog box, in the result pane, click **API**,  and then click **OK**.
 
#### Task 2: Exploring the application structure

1. In the **CakeStoreApi - Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.
...
4. In the **CakeStoreApi - Microsoft Visual Studio** window, in **Solution Explorer**, expand **Controllers**, and then click  **ValuesController.cs**.

    >**Note:** The **Get()** method returns **value1** and **value2**.

5. In the **CakeStoreApi – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**. 

    >**Note:** The browser displays **"["value1","value2"]"**.

6. In **Microsoft Edge**, click **Close**.

7. In the **CakeStoreApi (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.     
...
15. In the **Add Empty API Controller** dialog box, in the **Controller name** text box, type **CakeStoreApiController**, and then click **Add**.

16.  In the **CakeStoreApiController.cs** code block, place the cursor at the end of the **using Microsoft.AspNetCore.Mvc** namespace code, press Enter, and then type the following code:
...
19. Place the cursor at the end of the **using Microsoft.Extensions.DependencyInjection** namespace code, press Enter, and then type the following code:
...
4. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]/api/CakeStore/1**, and then press Enter.
    ...
    >**Note:** The browser displays the first cake store in **JSON** format.
...
5. In the **Name** text box, type **AnimalsMvc**.

6. In the **Location** textbox, replace its content with **Allfiles\Mod01\Labfiles\03_AnimalsMvc_begin**, and then click **OK**.
...
1. In the **AnimalsMvc - Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.
...
4. In **Solution Explorer**, expand **Views**, and then click **_ViewStart.cshtml**.

5. In the **_ViewStart.cshtml** code window, note the value for **Layout** is **"_Layout";**.

6. In **Solution Explorer**, under **Views**, expand **Home**, and then click **Contact.cshtml**.

7. In the **Contact.cshtml** code window, note there are no files with the .css extension.

8. In **Solution Explorer**, under **Views**, collapse **Home**, expand **Shared**, and then click **_Layout.cshtml.**

9. In the **_Layout.cshtml** code window, note in the **HEAD** element, there is a link to **~/css/site.css**.

10. In **Solution Explorer**, under **AnimalsMvc**, expand **wwwroot**, expand **css**, and then click **site.css**.

    >**Note:** This is the CSS **style sheet** file that was applied in the **_Layout.cshtml**.
...
5. In the **Template** selector, select **Empty (without model)**, select the **Use a layout page** check box, and then click **Add**.
...
8. In **Solution Explorer**, under **Views**, expand **Shared**, and then click **_Layout.cshtml.**
...
11. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Models**, point to **Add**, and then click **Class**.

12. In the **Add New Item – AnimalsMvc** dialog box, in the **Name** text box, type **Animal**, and then click **Add**.
    
13. In the **Animal.cs** code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
...
14. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Models**, point to **Add**, and then click **New Item**. 

15. In the **Add New Item - AnimalsMvc** dialog box, click **Interface**. 

16. In the **Add New Item – AnimalsMvc** dialog box, in the **Name** text box, type **IData**, and then click **Add**.

17. In the **IData** interface code block, place the cursor before the word **interface**, and then write **public**.

18. In the **IData** interface code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
...
19.  In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Models**, point to **Add**, and then click **Existing Item**.

20. In the dialog box, navigate to **Allfiles\Mod01\Labfiles\03_AnimalsMvc_begin**, click **Data.cs**, and then click **Add**.

    >**Note:** Examine the **Data.cs** content.

21. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Models**, point to **Add**, and then click **Class**.

22. In the **Add New Item – AnimalsMvc** dialog box, in the **Name** text box, type **IndexViewModel**, and then click **Add**.

23.  In the **IndexViewModel.cs** code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
  ```cs
       public List<Animal> Animals { get; set; }
```

24. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Controllers**, point to **Add**, and then click **Controller**.

25. In the **Add Scaffold** dialog box, click **MVC Controller - Empty**, and then click **Add**.

26. In the **Add Empty MVC Controller** dialog box, in the **Controller name** text box, type **AnimalsController**, and then click **Add**.

27.  In the **AnimalsController.cs** code window, place the cursor at the end of the **using Microsoft.AspNetCore.Mvc** namespace code, press Enter, and then type the following code:
  ```cs
...
29. In the **AnimalsController.cs** code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
  ```cs
...
30. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, expand **wwwroot**, right-click **images**, point to **Add**, and then click  **Existing Item**.
...
33. In the **Add MVC View** dialog box, ensure that the name in the **View name** text box is **Index**.
...
36. In **Index.cshtml**, erase all the content in the window, and type the following code:
...
37. In the **AnimalsController.cs** code window, locate the following code, right-click the code, and then click **Add View**.

  ```cs
       public IActionResult Details(int? id)
```

38. In the **Add MVC View** dialog box, ensure that the name in the **View name** text box is **Details**.
...
41.  In **Details.cshtml**, erase all the content in the  window, and type the following code:
...
42. In **Solution Explorer**, under **Views**, under **Shared**, click **_Layout.cshtml.**
...
45. In the **AnimalsMvc  – Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.

46. Place the cursor at the end of the **using Microsoft.Extensions.DependencyInjection** namespace code, press Enter, and then type the following code:
...
47. In the **Startup.cs** code window, locate the following code:
  ...
  ```cs
       services.AddMvc();
```
48. Place the cursor before the located code, type the following code, and then press Enter.
...
8.  In the **AnimalsMvc (Running) - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.

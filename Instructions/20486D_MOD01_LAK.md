...
5. In the **_ViewStart.cshtml** code window, note that the value of Layout is **"_Layout"** .
    ...
    >**Note:** This indicates that all the files inside the **Pages** use the same layout file, **~/Pages/_Layout.cshtml**.
...
8. In the Solution Explorer pane, expend **Pages**, and then click  **_Layout.cshtml**.

9. In the **_Layout.cshtml** code window, in the **HEAD** element, note that there is a link to **~/css/site.css**.

10. In the Solution Explorer pane, expand **wwwroot**, and then in the **css**, and then click **site.css**.

11. In the **site.css** code window, verify the style sheet for **_Layout.cshtml**.
...
11. In the **Actor** class code block, press Enter, and then type the following code.
...
```
12. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, right-click on the **Models**, point to **Add** , and then click **New Item**.
...
15. In the **IData** interface code block place the mouse cursor before the word **interface**, and type **public**.
...
```
17. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, right-click on the **Models**, point to **Add** , and select  **Existing Item**.

18. In the dialog box navigate to **Allfiles/Mod01/Labfiles/01_ActorsRazorPages_begin**, click **Data.cs**, and then click **Add**.

19. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window,  expend **wwwroot**, right click on the **images**, point to **Add**, and then click  **Existing Item**.
...
21. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window,  right-click **Pages**, point to **Add**, and select **New folder**.

22. In the Solution Explorer pane, rename **New Folder** as **Actors**, and then press Enter.

23. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, expend **pages**, right-click on **Actors**, point to **Add**, and then click **New Item**. 
...
```
28. In the **Index.cshtml.cs** class code block, press Enter, and then type the following code.
...
30. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window,expand **Pages**, right click on the **Actors**, point to **Add**, and then click  **Existing Item**.

31. In the dialog box navigate to **Allfiles/Mod01/Labfiles/01_ActorsRazorPages_begin/Pages**, select **Details.cshtml.cs**, **Details.cshtml** and then click **Add**. 
...
36. In the Solution Explorer pane of the **ActorsRazorPages – Microsoft Visual Studio** window, expand **pages**, double-click  **_Layout.cshtml**.
...
8. On the **DUBUG** Menu, click **Stop Debugging**.
...
5. In the **CakeStore** class code block, press Enter, and then type the following code.
...
9. In the **IData** class code block, place the mouse cursor before the word **interface** type **public**.

10. In the **IData** class code block, press Enter, and then type the following code.
...
15. In the **Controller name** text box of the **Add Controller** dialog box, type **CakeStoreApiController**, and then click **Add**.
...
```
17. In the **CakeStoreApiController** class code block, press Enter, and then type the following code.

...
29. In the **Index.cshtml.cs** code block, place the mouse cursor after the second **{** (opening brackets) sign, press Enter, type the following code, and then press Enter again.

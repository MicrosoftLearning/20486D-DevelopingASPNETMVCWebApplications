...
5. In the Name box, type **ActorsRazorPages**, and then click **OK**.
...
10. On the **DEBUG** menu of the **ActorsRazorPages (Running) - Microsoft Visual Studio** window, click **Stop Debugging**.
...
5. In the Name box, type **CakeStoreApi**, and then click **OK**.
...
1. In the Solution Explorer pane, expand **Views**, and right-click **Home**, point to **Add**, and then click **View**. 
...
5. In the Solution Explorer pane, expand **Controllers**, click **HomeController.cs**, and then locate the following code.

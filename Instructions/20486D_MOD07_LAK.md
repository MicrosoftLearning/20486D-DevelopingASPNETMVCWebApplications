...
```
5. Ensure that the mouse cursor is at the end of the **System.Threading.Tasks** namespace, press Enter, and then type the following code:
  ```cs
...
6. In the **Cupcake.cs** code block, press Enter and then type the following code:
  ```cs
       [Key]
...
9. In the **Bakery.cs** code window, locate the following code:
  ```cs
       using System.Threading.Tasks;
```
10. Ensure that the mouse cursor is at the end of the **System.Threading.Tasks** namespace, press Enter, and then type the following code:
  ```cs
       using System.ComponentModel.DataAnnotations;
```

11. In the **Bakery.cs** code block, press Enter and then type the following code:
  ```cs
       [Key]
       public int BakeryId { get; set; }
...
```
3. Ensure that the mouse cursor is at the end of the  **Microsoft.Extensions.DependencyInjection** namespace, press Enter, and then type the following code:
  ```cs
...
11. Place the mouse cursor before the located code, type the following code, and then press Enter twice.
  ```cs
...
5. In the **OnModelCreating** method code block, immediately after the code you just added, press Enter, and type the following code:
  ```cs
...
3. In the **Cupcakes - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Repositories**, click **Add**, and then click **New Item**.
...
17. In the **CupcakeRepository.cs** code block, press Enter, and then type the following code:
  ```cs
...
26. Ensure that the mouse cursor is at the end of the  **Microsoft.EntityFrameworkCore** namespace, press Enter, and then type the following code:
  ```cs
...
28. Place the mouse cursor before the located code, type the following code and then press Enter.
  ```cs
...
4. In the **Create** action code block created with **HTTP POST verb**, type the following code and then press Enter.
  ```cs
...
5. Ensure that the cursor is at the end of the **Create** action code block with **HTTP verb POST**, press Enter, and then type the following code:
  ```cs
       [HttpGet]
...
```
12. In the **DeleteConfirmed** action code block created with **HTTP POST verb**, type the following code and then press Enter.
  ```cs
...
2. In the navigation pane of the **Add New Item - Cupcakes** dialog box, click **ASP.NET Core**, in the result pane, click **App Settings File**, and then click **Add**.
...
5. In the **Cupcakes - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Cupcakes**, point to **Open Folder in File Explorer**, and then click.

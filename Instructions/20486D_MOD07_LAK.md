...
7. In the command prompt, type the following command, and then close the window.
  ```cs
     dotnet ef database update
```
8. In the **Cupcakes - Microsoft Visual Studio** window, on the **View** menu, click **SQL Server Object Explorer**.

9. In the **Cupcakes - Microsoft Visual Studio** window, in **SQL Server Object Explorer**, expand **(localdb)\MSSQLLocalDB**, expand **Databases**, and then expand **BakeriesDb**.

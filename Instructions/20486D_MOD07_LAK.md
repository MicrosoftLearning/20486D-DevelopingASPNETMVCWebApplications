...
18. Ensure that the cursor is at the end of the **constructor** code block, press Enter twice, and then type the following code:
  ```cs
...
3. In the **Create** action code block, type the following code:
  ```cs
       ...
       return View();
```
4. Ensure that the cursor is at the end of the **Create** action code block, press Enter twice, and then type the following code:
  ```cs
...
5. In the **CreatePost** method code block created, type the following code:
  ```cs
...
6. Ensure that the cursor is at the end of the **CreatePost** method code block, press Enter twice, and then type the following code:
  ```cs
       [HttpGet]
...
8. Ensure that the cursor is at the end of the **Edit** action code block, press Enter twice, and then type the following code:
  ```cs
...
```
9. In the **EditPost** method code block created, type the following code:
  ```cs
...
10. Ensure that the cursor is at the end of the **EditPost** action code block, press Enter twice, and then type the following code:
  ```cs
       [HttpGet]
...
12. Ensure that the cursor is at the end of the **Delete** action code block, press Enter twice, and then type the following code:
  ```cs
...
```
13. In the **DeleteConfirmed** method code block created with **HTTP POST verb**, type the following code:
  ```cs
...
4. On the **Add a Cupcake to the Shop** page, in the **Bakery** list, select _&lt;A bakery of your choice&gt;._

5. On the **Add a Cupcake to the Shop** page, in the **Cupcake Type** list, select _&lt;A cupcake type of your choice&gt;._

6. On the **Add a Cupcake to the Shop** page, in the **Description** text box, type _&lt;A cupcake description of your choice&gt;._

7. On the **Add a Cupcake to the Shop** page, in the **Gluten Free** text box, check _&lt;Choose if the cupcake is a gluten-free&gt;._

8. On the **Add a Cupcake to the Shop** page, in the **Price** text box, type _&lt;A cupcake price of your choice between 1 and 15&gt;._

9. On the **Add a Cupcake to the Shop** page, in the **Cupcake Picture** box, import from **Allfiles\Mod07\Labfiles\Image** a **strawberry-cupcake.jpg** image,_ and then click **Submit**.

10. On the **Welcome to our Cupcakes Shop** page, verify the newly submitted cupcake details.

11. On the **Welcome to our Cupcakes Shop** page, select a cupcake of your choice, and then click **Details**.
...
14. On the **Edit a Cupcake** page, in the **Price** text box, type _&lt;A cupcake price of your choice between 1 and 15&gt;_ , and then click **Save**.

15. On the **Welcome to our Cupcakes Shop** page, select the cupcake you edit, and then click **Details**.
...
18. On the **Cupcake's Delete** page, click **Delete**.

19. On the **Welcome to our Cupcakes Shop** page, verify that the cupcake deleted.
...
9. On the **Add a Cupcake to the Shop** page, in the **Cupcake Picture** box, import from **Allfiles\Mod07\Labfiles\Image** a **vanilla-cupcake.jpg** image,_ and then click **Submit**.
...
```
16. In the **Cupcakes - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Cupcake**, and then click **Edit.cshtml**.
...
```
19. In the **Cupcakes - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Cupcake**, and then click **Create.cshtml**.
...
```
22. In the **Cupcakes - Microsoft Visual Studio** window, on the **TOOLS** menu, select **NuGet Package Manager**, and then click **Package Manager Console**.

23. In **Package Manager Console** tab, type the following command, and then press Enter.
  ```cs
...
3. On the **Welcome to our Cupcakes Shop** page, select a cupcake of your choice, and then click **Details**.

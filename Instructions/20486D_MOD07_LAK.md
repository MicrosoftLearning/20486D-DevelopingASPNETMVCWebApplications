...
9. On the **Add a Cupcake to the Shop** page, in the Cupcake Picture box, import an image from **Allfiles\Mod07\Labfiles\Image\strawberry-cupcake.jpg**, and then click **Submit

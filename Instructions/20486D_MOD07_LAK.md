...
4. In the **Startup.cs** code window, place the cursor after the second **{** (opening braces) sign, press Enter, type the following code, and then press Enter.
  ```cs
...
5. In the **Startup.cs** code window, place the cursor after the **{** (opening braces) sign of the **ConfigureServices** method, press Enter, and then type the following code:
  ```cs
...
8. In the **Startup.cs** code window, place the cursor after the **{** (opening braces) sign of the **Configure** method, press Enter, type the following code, and then press Enter.
  ```cs
...
27. In the **Startup.cs** code window, place the cursor after the **{** (opening braces) sign of the **ConfigureServices** method, press Enter, and then type the following code:
  ```cs
...
4. In the **CupcakeController.cs** code block, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
  ```cs
...
3. Place the mouse cursor after the located code, type the following code, and then press Enter.
  ```cs
     <ItemGroup>
...
11. In the command Line window, type the following command, and then **close** the window.
  ```cs
     dotnet ef database update
```

12. In the **Cupcakes - Microsoft Visual Studio** window, on the **View** menu, click **SQL Server Object Explorer**.

13. In the **Cupcakes - Microsoft Visual Studio** window, in **SQL Server Object Explorer**, expand (localdb)\MSSQLLocalDB , expand Databases, and then expand BakeriesDb.

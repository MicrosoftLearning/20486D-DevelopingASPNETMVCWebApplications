...
6. In the **ConfigureServices** method code block, locate the following code.
...
10. In the Solution Explorer pane of the **Cupcakes - Microsoft Visual Studio** window, click **Program.cs**.

11. In the **Program.cs** code window, locate the following code.
...
13. In the **Main** method code block, select the following code.
...
24. In the Solution Explorer pane of the **Cupcakes - Microsoft Visual Studio** window, click **Startup.cs**.
...
27. In the **ConfigureServices** method code block, locate the following code.

...
1. In the **Cupcakes - Microsoft Visual Studio** window, in **Solution Explorer**, right-click **Cupcakes**, and then click **Open Folder in File Explorer**.

2. In the **File Explorer**, select the address in the address bar, type **cmd**, and then press Enter.
...
```
5. In the command prompt, locate the following line.
  ```cs
     Database name: BakeriesDb
```
>**Note:** The **Database** name is identical to the name in the **appsettings.json** file.

6. In the command prompt, type the following command, and then press Enter.
  ```cs
...
9. In the command prompt, type the following command, and then close the window.
  ```cs
     dotnet ef database update
```
10. In the **Cupcakes - Microsoft Visual Studio** window, on the **View** menu, click **SQL Server Object Explorer**.

11. In the **Cupcakes - Microsoft Visual Studio** window, in **SQL Server Object Explorer**, expand **(localdb)\MSSQLLocalDB**, expand **Databases**, and then expand **BakeriesDb**.
...
21. In the **Cupcakes - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

...
3. In the **ShirtStore - Microsoft Visual Studio** window,  In the **Output** window, click  the **Show output from** drop down, select the **ASP.NET Core Web Server** option, and then click the **Clear All** button.
...
8. In the **ShirtStore - Microsoft Visual Studio** window, in the **Output** window, locate the text: "A Yellow shirt of size XS with a price of $12.00 was added successfully."

9. In **Microsoft Edge**, on the **Shirts in stock** list of shirts, click on the top **Delete** link.

10. In the **ShirtStore - Microsoft Visual Studio** window, in the **Output** window, locate the text: "A shirt with id 1 was removed successfully."
...
4. In the **ShirtStore - Microsoft Visual Studio** window, in **Solution Explorer**, click **shirt_store_logs-XXXXXXXX.txt**, and then inspect the **ArgumentNullException** stack trace.

...
3. In **Solution Explorer**, under **ShirtStoreWebsite.Tests**, right-click **UnitTest1**, and then click **Rename**.

4. In the **UnitTest1** text box, type **ShirtTest**, and then press Enter.

5. In the **Microsoft Visual Studio** dialog box, click **Yes**.

6. In **Solution Explorer**, right-click **ShirtTest**, and then click **Cut**.
...
4. In the **NewFolder** text box, type **Controllers**, and then press Enter.
...
6. In the **Add New Item - ShirtStoreWebsite.Tests** dialog box, in the **Name** text box, type **ShirtControllerTest**, and then click **Add**.
...
1. In the **ShirtStore - Microsoft Visual Studio** window, on the **TEST** menu, point to **Run**, and then click **All Tests**.
    >**Note:** The **Test Explorer** displays 2 passed tests: **IndexModelShouldContainAllShirts** and **IsGetFormattedTaxedPriceReturnsCorrectly**.
...
8. In the **ShirtStore – Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.
      ...
      >**Note:** **ShirtControllerTest** must be updated because we added parameter to the ShirtController constructor **ILogger<ShirtController> logger**, following the update the test will pass correctly.
...
8. In **Microsoft Edge**, on the **Size** list box, click **M**.

9. In **Microsoft Edge**, on the **Color** list box, click **Yellow**.

...
3. In the **ShirtStore - Microsoft Visual Studio** window, In **Solution Explorer**, right-click **ProductsWebsite.Tests**, point to **Add**, and then click **Class**.
...
1. In the **ShirtStore - Microsoft Visual Studio** window, in **Solution Explorer**, under **ShirtStoreWebsite** project, under **Controllers**, click **ShirtController.cs**.
...
3. In **Microsoft Edge**, on the **Shirts in stock** list of shirts, click on the top **Delete** link.
...
11. In the **Add New Item - ShirtStoreWebsite** dialog box, in the **Name** text box, type **appsettings.production.json**, and then click **Add**.

12. In **Solution Explorer**, expand **appsettings.json**, and then click **appsettings.production.json**.
...
6. In the **ShirtStore - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.

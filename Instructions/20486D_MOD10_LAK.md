...
4. In the **ShirtStore - Microsoft Visual Studio** window,  In the **Output** tab, click  the **Show output from** drop down, select **ASP.NET Core Web Server**, and then click **Clear All**.
...
9. In the **ShirtStore - Microsoft Visual Studio** window, in the **Output** tab, locate the following text:
```
    ShirtStoreWebsite>       A Yellow shirt of size M with a price of $12.00 was added successfully.
```
10. In the **ShirtStore - Microsoft Visual Studio** window,  In the **Output** tab, click **Clear All**.

11. In **Microsoft Edge**, on the **Shirts in stock** table, click on the top **Delete** link.

12. In the **ShirtStore - Microsoft Visual Studio** window, in the **Output** tab, locate the following text:
```
...
6. In **shirt_store_logs-XXXXXXXX.txt** editor window, click **Close**.

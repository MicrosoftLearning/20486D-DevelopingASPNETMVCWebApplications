...
3. In the **ShirtStore - Microsoft Visual Studio** window, in the **Output** pane, click the **Output** tab.

4. On the **Output** tab, click  the **Show output from** drop down, select **ASP.NET Core Web Server**, and then click the **Clear All** button.
...
9. In the **ShirtStore - Microsoft Visual Studio** window, on the **Output** tab, locate the following text:
```

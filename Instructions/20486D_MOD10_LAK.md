...
In the **ShirtStore - Microsoft Visual Studio** window, on the **TEST** menu, point to **Run**, and then click **All Tests**.
...
5. In File Explorer, navigate to **[Repository Root]\Allfiles\Mod10\Labfiles\01_ShirtStore_begin\ShirtStoreWesite**, and then double-click **shirt_store_logs-XXXXXXXX.txt**.

    >**Note**: Inspect the **ArgumentNullException** stack trace.

6. In the **shirt_store_logs-XXXXXXXX.txt** window, click **Close**.
...
14. In File Explorer, navigate to **[Repository Root]\Allfiles\Mod10\Labfiles\01_ShirtStore_begin\ShirtStoreWesite**, and then double-click **shirt_store_logs-XXXXXXXX.txt**.

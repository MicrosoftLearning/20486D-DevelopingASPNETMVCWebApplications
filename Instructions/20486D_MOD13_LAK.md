...
12. In the **ThankYou** action code block, type the following code:
  ```cs
       return View();
```
13.  In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, under **Views**, under **JobApplication**, click **Create.cshtml**.

    >**Note:** Examine the file content.

14. In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, expand **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.
...
```
21. Place the cursor after the located code, press Enter twice, and then type the following code:
  ```cs
       @section Scripts{

...
6. In the **Add Empty MVC Controller** dialog box, in the **Controller name** text box, type **RestaurantBranchesController**, and then click **Add**.
...
```
13.  In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, expand **Views**, expand **Restaurant**, and then click **Index.cshtml**.
...
4. In the **Add New Item – Restaurant** dialog box, in the **Name** text box, type **wanted-ad-get**, and then click **Add**.

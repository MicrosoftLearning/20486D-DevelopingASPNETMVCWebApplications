...
9. In **Solution Explorer**, right-click **Server**, point to **Add**, and then click **New Folder**.

10. In the **NewFolder** text box, type **Controllers**, and then press Enter.

11. In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Server** right-click the **Controllers** folder, point to **Add**, and then click **Controller**.

12. In the **Add Scaffold** dialog box, click **API Controller - Empty**, and then click **Add**.

13. In the **Add Empty API Controller** dialog box, in the **Controller name** text box, type **RestaurantBranchesController**, and then click **Add**.

14. In the **RestaurantBranchesController.cs** code window, locate the following code:
  ```cs
       using Microsoft.AspNetCore.Mvc;
```
15. Ensure that the cursor is at the end of the **Microsoft.AspNetCore.Mvc** namespace, press Enter, and then type the following code:
  ```cs
       using Server.Data;
       using Server.Models;
```
16. In the **RestaurantBranchesController.cs** code window, place the cursor after the second **{** (opening braces) sign, press Enter, and then type the following code:
  ```cs
...
```
17. Ensure that the cursor is at the end of the **RestaurantBranchesController** constructor code block, press Enter twice, and then type the following code:
  ```cs
       [HttpGet]
...
```
18. In the **Get** action code block, type the following code:
  ```cs

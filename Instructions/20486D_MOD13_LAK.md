...
3.  In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, under **Views**, under **Reservation**, and then click **ThankYouAsync.cshtml**.

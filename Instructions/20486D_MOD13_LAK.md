...
4. In the **Add New Item – Restaurant** dialog box, in the **Name** box, type **wanted-ad-get**, and then click **Add**.
...
4. In the **Add New Item – Restaurant** dialog box, in the **Name** box, type **wanted-ad-post**, and then click **Add**.
...
11. On **Submit Job Application**, in the **Email** box, type _&lt;An email time of your choice&gt;._

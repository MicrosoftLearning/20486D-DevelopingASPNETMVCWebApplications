...
4. In the **WantedAdController.cs** code window, right-click the following code, and then click **Add View**.
  ```cs
       public IActionResult Index()
```
5. In the **Add MVC View** dialog box, ensure that the name in the **View name** text box is **Index**.
...
9. Replace the selected code with the following code:
  ```cs
       <h2 class="title">
             ...
             <span class="span-col-s">Wanted Ad</span>
             <button class="btn btn-outline-danger" type="button" onclick="location.href='@Url.Action("Create", "JobApplication")'">Submit Job Application</button>
       </h2>
       <div class="container-view">
       </div>
``` 

10. In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, expand **wwwroot**, right-click **js**, point to **Add**, and then click **New Item**.

11. In the **Add New Item – Restaurant** dialog box, in the navigation pane, under **Installed**, expand **ASP.NET Core**, and then click **Web**.

12. In the **Add New Item – Restaurant** dialog box, in the result pane, click **JavaScript File**.

13. In the **Add New Item – Restaurant** dialog box, in the **Name** text box, type **wanted-ad-get**, and then click **Add**.

14. In the **wanted-ad-get.js** code window, type the following code:
  ```cs
       $(function () {
          $.ajax({
              type: "GET",
...
15. In the **wanted-ad-get.js** code window, locate the following code:
  ```cs
       success: function (data) {
       },
```

16. Ensure that the cursor is after the **{** (opening brace) sign, press Enter, and then type the following code:
  ```cs
...
17. In the **Restaurant - Microsoft Visual Studio** window, in **Solution Explorer**, under **Client**, under **Views**, under **WantedAd**, click **Index.cshtml**.

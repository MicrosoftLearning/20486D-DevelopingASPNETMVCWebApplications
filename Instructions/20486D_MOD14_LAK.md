...
2. In the **File Explorer**, navigate to **Allfiles\Mod14\Labfiles\01_Underwater_begin\Underwater**, and then copy the address in the address bar.
...
3. In **Package Manager Console** tab, type the following command, and then press Enter.
  ```cs
       Update-Database
```
4. In the **Underwater - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.

5. In **Microsoft Edge**, in the menu bar, click **Add Fish**.
 
6. On the **Add a Fish to Aquarium** page, in the **Aquarium** list, select _&lt;A aquarium of your choice&gt;._

7. On the **Add a Fish to Aquarium** page, in the **Fish Name** text box, type _&lt;A fish name of your choice&gt;._

8. On the **Add a Fish to Aquarium** page, in the **Scientific Name** text box, type _&lt;A scientific name of your choice&gt;._

9. On the **Add a Fish to Aquarium** page, in the **Picture** file chooser, go to **Allfiles\Mod14\Labfiles\Images**, click **koi.jpg**, and then click **Open**.
...
20. On the **Delete** page, click **Delete**.
...
14. In the **New server** window, in the **Confirm password** text box, type **p@@sw0rd**.
...
14. In the **Publish** window, click **Configure**.
...
6. On the **Add a Fish to Aquarium** page, in the **Picture** file chooser, go to **Allfiles\Mod14\Labfiles\Images**, click **salmon.jpg**, and then click **Open**.
...
```
13. In the **Underwater - Microsoft Visual Studio** window, in **Solution Explorer**, under **Views**, under **Aquarium**, click **Create.cshtml**.
...
17. In the **AquariumController.cs** code block, select the following code:
  ```cs
...
23. In the **Pick a publish target** dialog box, verify that **Underwater {unique name}** is selected in the drop down, and then click **Publish**.
...
26. On the **Add a Fish to Aquarium** page, in the **Fish Name** text box, type _&lt;A fish name of your choice&gt;._

27. On the **Add a Fish to Aquarium** page, in the **Scientific Name** text box, type _&lt;A scientific name of your choice&gt;._

28. On the **Add a Fish to Aquarium** page, in the **Common Name** text box, type _&lt;A common name of your choice&gt;._

29. On the **Add a Fish to Aquarium** page, in the **Picture** file chooser, go to **Allfiles\Mod14\Labfiles\Images**, click **tuna.jpg**, and then click **Open**.
...
33. View the fish details, and then click **Back to List**.

34. On the **Dive into Our Fish Species** page, select a fish of your choice, and then click **Edit**.

35. On the **Edit Fish** page, in the **Scientic Name** text box, type _&lt;A scientific name of your choice&gt;_ , and then click **Save**.

36. On the **Dive into Our Fish Species** page, select the fish you edited, and then click **Details**.

37. On the **Fish Details** page, verify the newly edited fish details, and then click **Back**.

38. On the **Dive into Our Fish Species** page, select a fish of your choice, and then click **Delete**.

39. On the **Fish Delete** page, click **Delete**.
...
18. In the **Search** text box, type **WindowsAzure.Storage**, and then press Enter.
...
21. In **UnderwaterRepository.cs** code window, select the following code:
  ```cs
...
24. Ensure that the cursor is at the end of the **PopulateAquariumsDropDownList** method code block, press Enter twice, and then type the following code:
  ```cs
...
25. Ensure that the cursor is at the end of the **UploadImageAsync** method code block, press Enter twice, and then type the following code:
  ```cs
...
26. In **UnderwaterRepository.cs** code window, select the following code:
  ```cs
...
28. In **UnderwaterRepository.cs** code window, select the following code:
  ```cs
...
30. In the **Underwater - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

31. In the **Underwater - Microsoft Visual Studio** window, on the **TOOLS** menu, point to **NuGet Package Manager**, and then click **Package Manager Console**.

32. In **Package Manager Console** tab, type the following command, and then press Enter.
  ```cs
       Add-Migration AddFishImageURL
```

33. In **Package Manager Console** tab, type the following command, and then press Enter.
  ```cs
       Update-Database
```
...
2. In the **Publish window**, next to the **Publish** button, ensure that **Underwater {unique name}** is selected in the drop down, and then click **Publish**.
...
5. On the **Add a Fish to Aquarium** page, in the **Fish Name** text box, type _&lt;A fish name of your choice&gt;._

6. On the **Add a Fish to Aquarium** page, in the **Scientific Name** text box, type _&lt;A scientific name of your choice&gt;._

7. On the **Add a Fish to Aquarium** page, in the **Common Name** text box, type _&lt;A common name of your choice&gt;._

8. On the **Add a Fish to Aquarium** page, in the **Picture** file chooser, go to **Allfiles\Mod14\Labfiles\Images**, click **clown-trigger.jpg**, and then click **Open**.
...
11. Close **Microsoft Edge** window.
...
14. In the portal, in the menu on left-hand side, click **Storage Accounts**. 
...
18. Click **clownfish.jpg**.

19. Click **Edit blob**.

    >**Note:** The uploaded image is displayed.

20. Close **Microsoft Edge** window.

...
13. In the **ConfigureMiddlewareExample – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**. 
...
18. Place the cursor after the **{** (opening braces) sign, press Enter, type the following code, and then press Enter.
```cs
...
19. In the **ConfigureMiddlewareExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

20. In the **ConfigureMiddlewareExample – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.

21. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]/UrlTest1**, and then press Enter.
    >**Note**: The browser displays: "This text was generated by the app.Use middleware. Request path is: /UrlTest1".

22. In **Microsoft Edge**, in the address bar, type **http://localhost:[port]/UrlTest2**, and then press Enter.
...
26. In the **ConfigureMiddlewareExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

27. In the **ConfigureMiddlewareExample – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.
...
29. In the **Startup.cs** code window, select the following code:
```cs
    app.Use(async (context, next) =>
    {
        await context.Response.WriteAsync("This text was generated by the app.Use middleware. Request path is: " + context.Request.Path.Value + "<br />");
...
30. Right-click the selected code, and then click **Cut**.

31. In the **Startup.cs** code window, locate the following code:
```cs
    app.Run(async (context) =>
    {
        await context.Response.WriteAsync("This text was generated by the app.Run middleware.");
...
32. Place the cursor at the end of the located code, press Enter twice, right-click at the cursor location, and then click **Paste**.

33. In the **ConfigureMiddlewareExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

34. In the **ConfigureMiddlewareExample – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.
    >**Note**: The browser displays: "This text was generated by the app.Run middleware."

35. In **Microsoft Edge**, click **Close**.

36. In the **Startup.cs** code window, select the following code:
```cs
    app.Run(async (context) =>
    {
        await context.Response.WriteAsync("This text was generated by the app.Run middleware.");
...
37. Right-click the selected code, and then click **Cut**.

38. In the **Startup.cs** code window, locate the following code:
```cs
    app.Use(async (context, next) =>
    {
        await context.Response.WriteAsync("This text was generated by the app.Use middleware. Request path is: " + context.Request.Path.Value + "<br />");
...
39. Place the cursor at the end of the located code, press Enter twice, right-click at the cursor location, and then click **Paste**.

40. In the **ConfigureMiddlewareExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

41. In the **ConfigureMiddlewareExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Exit**.
...
12. In the **wwwroot** window, right-click an empty space, and then click **Paste**.
    >**Note**: In the **StaticFilesExample - Microsoft Visual Studio** window, in **Solution Explorer**, ensure that the **wwwroot** folder contains the copied files (You might need to expand the wwwroot directory to view the files).

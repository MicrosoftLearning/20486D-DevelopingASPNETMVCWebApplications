...
18. Place the cursor within the **Logger.cs** code block, press Enter, and then type the following code:
```cs
    string _fileName;
```
...
20. Place the cursor within the **Logger** constructor code block, press Enter, and then type the following code:
```cs
...
22. In the **ConfigureServiceExample - Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.
...
26. In the **ConfigureServiceExample - Microsoft Visual Studio** window, in **Solution Explorer**, click **Startup.cs**.
...
33. Place the cursor after the **{** (opening braces) sign, press Enter, and then type the following code:
```cs
    log.Log("Logged line");
```
34. In the **ConfigureServiceExample- Microsoft Visual Studio** window, on the **FILE** menu, click **Save All**.

35. In the **ConfigureServiceExample – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Debugging**.
...
36. In **Microsoft Edge**, click **Close**.

37. In the **ConfigureServiceExample (Running) – Microsoft Visual Studio** window, on the **DEBUG** menu, click **Stop Debugging**.

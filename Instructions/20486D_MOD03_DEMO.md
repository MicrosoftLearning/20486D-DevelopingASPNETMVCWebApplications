...
26. Place the cursor after the **{** (opening braces) sign, press Enter, type the following code, and then press Enter.
```cs
    app.UseStaticFiles();
```
...
12. In the **ConfigureServiceExample - Microsoft Visual Studio** window, in **Solution Explorer** pane, right-click **ConfigureServiceExample**, point to **Add**, and then click **New Folder**.
...
33. Place the cursor after the **{** (opening braces) sign, press Enter, type the following code, and then press Enter.
```cs
    log.Log("Logged line");
```

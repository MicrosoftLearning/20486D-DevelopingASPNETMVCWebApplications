...
6. In the **Location** box, write **Allfiles\Mod03\Democode\01_ConfigureMiddlewareExample_begin**, and then click **OK**. 
...
6. In the **Location** box, write **Allfiles\Mod03\Democode\03_ConfigureServiceExample_begin**, and then click **OK**. 

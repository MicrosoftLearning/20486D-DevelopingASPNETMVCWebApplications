...
11. In the **Startup.cs** code window, place the cursor within the **Startup.cs** code block, below the **ConfigureServices** method, and then type the following code:
```cs
...
16. In the **Startup.cs** code window, place the cursor within the **Startup.cs** code block, below the **ConfigureServices** method, and then type the following code:
```cs
    public void Configure(IApplicationBuilder app)
    {
        app.Run(async (context) =>

...
19. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/UrlTest1, and then press Enter.
...
20. In the **Microsoft Edge**, Change the URL path to http://localhost:[port]/UrlTest2, and then press Enter. 
     >**Note**: The browser displays **This text was generated by the custom middleware. URL Path = [URL Path]** that generated by the **app.Use** middleware.

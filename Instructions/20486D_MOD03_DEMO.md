...
19. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter again.
```cs
...
4. In the **New Project** dialog box, in the result pane of, click **ASP.NET Core Web Application**.
...
26. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter again.
```cs
    app.UseStaticFiles();
```
...
33. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter again.
```cs
    log.Log("Logged line");
```

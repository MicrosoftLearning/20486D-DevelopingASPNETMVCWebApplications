...
19. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter.
```cs
...
26. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter.
```cs
    app.UseStaticFiles();
```
...
33. Place the cursor after the **{** (opening bracket) sign, press Enter, type the following code, and then press Enter.
```cs
    log.Log("Logged line");
```

...
26. Place the cursor after the **{** (opening braces) sign, press Enter, type the following code:
```cs
    app.UseStaticFiles();
```
...
33. Place the cursor after the **{** (opening braces) sign, press Enter, type the following code:
```cs
    log.Log("Logged line");
```

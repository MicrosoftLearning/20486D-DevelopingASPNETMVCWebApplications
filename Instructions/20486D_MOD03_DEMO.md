...
22. In the **Microsoft Edge** window, Change the URL path to http://localhost:[port]/UrlTest1, and then press Enter.
     >**Note**: The browser displays: "This text was generated by the app.Use middleware. Request path value is: /UrlTest1".
23. In the **Microsoft Edge** window, Change the URL path to http://localhost:[port]/UrlTest2, and then press Enter. 
     >**Note**: The browser displays: "This text was generated by the app.Use middleware. Request path value is: /UrlTest2".
...
33. Place the mouse cursor after the { (opening brackets) sign, press Enter, type the following code, and then press Enter again.
```cs
    log.Log("Logged line");
```
